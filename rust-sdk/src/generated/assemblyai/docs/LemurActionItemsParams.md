...
**answer_format** | Option<**String**> | How you want the action items to be returned. This can be any text. Defaults to \"Bullet Points\".  | [optional][default to Bullet Points]
