...
pub struct LemurQuestionAnswerParams {
    ...
    pub questions: Vec<models::LemurQuestion>,
}

impl LemurQuestionAnswerParams {
    pub fn new(final_model: models::LemurBaseParamsFinalModel, questions: Vec<models::LemurQuestion>) -> LemurQuestionAnswerParams {
