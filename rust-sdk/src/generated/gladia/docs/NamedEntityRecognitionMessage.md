...
**r#type** | **String** |  | [default to NamedEntityRecognition]
**data** | [**models::NamedEntityRecognitionData**](NamedEntityRecognitionData.md) | The message data. \"null\" if the addon failed | 
