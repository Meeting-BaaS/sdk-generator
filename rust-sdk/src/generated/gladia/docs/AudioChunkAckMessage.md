...
**r#type** | **String** |  | [default to AudioChunk]
**data** | [**models::AudioChunkAckData**](AudioChunkAckData.md) | The message data. \"null\" if the action was not successfully acknowledged | 
