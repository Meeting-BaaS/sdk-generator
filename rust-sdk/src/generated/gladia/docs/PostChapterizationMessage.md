...
**r#type** | **String** |  | [default to PostChapterization]
**data** | [**models::PostChapterizationMessageData**](PostChapterizationMessageData.md) | The message data. \"null\" if the addon failed | 
