...
pub struct StopRecordingAckMessage {
    ...
    #[serde(rename = "data")]
    pub data: Box<models::StopRecordingAckData>,
}

impl StopRecordingAckMessage {
    pub fn new(session_id: String, created_at: String, acknowledged: bool, error: models::Error, r#type: Type, data: models::StopRecordingAckData) -> StopRecordingAckMessage {
