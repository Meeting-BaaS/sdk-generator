...
pub struct TranslationMessage {
    ...
    #[serde(rename = "data")]
    pub data: Box<models::TranslationData>,
}

impl TranslationMessage {
    pub fn new(session_id: String, created_at: String, error: models::Error, r#type: Type, data: models::TranslationData) -> TranslationMessage {
        TranslationMessage {
            session_id,
            created_at,
            error: Box::new(error),
