...
pub struct CallbackLivePostTranscriptMessage {
    ...
    pub payload: Box<models::PostTranscriptMessage>,
}

impl CallbackLivePostTranscriptMessage {
    pub fn new(id: uuid::Uuid, event: Event, payload: models::PostTranscriptMessage) -> CallbackLivePostTranscriptMessage {
