...
pub struct AudioToLlmDto {
    ...
    pub results: Box<models::AudioToLlmResultDto>,
}

impl AudioToLlmDto {
    pub fn new(success: bool, is_empty: bool, exec_time: f64, error: models::AddonErrorDto, results: models::AudioToLlmResultDto) -> AudioToLlmDto {
        AudioToLlmDto {
            success,
            is_empty,
            exec_time,
