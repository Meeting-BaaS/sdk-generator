...
pub struct CallbackLiveStartRecordingMessage {
    ...
    pub payload: Box<models::StartRecordingMessage>,
}

impl CallbackLiveStartRecordingMessage {
    pub fn new(id: uuid::Uuid, event: Event, payload: models::StartRecordingMessage) -> CallbackLiveStartRecordingMessage {
