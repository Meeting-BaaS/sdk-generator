...
pub struct AudioToLlmListDto {
    ...
    pub results: Vec<models::AudioToLlmDto>,
}

impl AudioToLlmListDto {
    pub fn new(success: bool, is_empty: bool, exec_time: f64, error: models::AddonErrorDto, results: Vec<models::AudioToLlmDto>) -> AudioToLlmListDto {
        AudioToLlmListDto {
            success,
            is_empty,
            exec_time,
