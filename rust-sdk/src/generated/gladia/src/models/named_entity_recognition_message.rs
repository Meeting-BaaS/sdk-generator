...
pub struct NamedEntityRecognitionMessage {
    ...
    #[serde(rename = "data")]
    pub data: Box<models::NamedEntityRecognitionData>,
}

impl NamedEntityRecognitionMessage {
    pub fn new(session_id: String, created_at: String, error: models::Error, r#type: Type, data: models::NamedEntityRecognitionData) -> NamedEntityRecognitionMessage {
