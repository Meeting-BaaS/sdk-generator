...
pub struct PreRecordedResponse {
    ...
    pub request_params: Option<Box<models::PreRecordedRequestParamsResponse>>,
    /// Pre-recorded transcription's result when status is \"done\"
    #[serde(rename = "result", skip_serializing_if = "Option::is_none")]
    pub result: Option<Box<models::TranscriptionResultDto>>,
}

impl PreRecordedResponse {
    pub fn new(id: uuid::Uuid, request_id: String, version: i32, status: Status, created_at: String, post_session_metadata: serde_json::Value, kind: Kind) -> PreRecordedResponse {
        PreRecordedResponse {
            id,
            request_id,
            version,
