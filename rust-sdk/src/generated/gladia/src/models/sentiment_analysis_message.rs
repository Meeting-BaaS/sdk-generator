...
pub struct SentimentAnalysisMessage {
    ...
    #[serde(rename = "data")]
    pub data: Box<models::SentimentAnalysisData>,
}

impl SentimentAnalysisMessage {
    pub fn new(session_id: String, created_at: String, error: models::Error, r#type: Type, data: models::SentimentAnalysisData) -> SentimentAnalysisMessage {
