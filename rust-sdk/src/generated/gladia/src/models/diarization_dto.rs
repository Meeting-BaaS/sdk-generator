...
pub struct DiarizationDto {
    ...
    pub results: Vec<models::UtteranceDto>,
}

impl DiarizationDto {
    pub fn new(success: bool, is_empty: bool, exec_time: f64, error: models::AddonErrorDto, results: Vec<models::UtteranceDto>) -> DiarizationDto {
        DiarizationDto {
            success,
            is_empty,
            exec_time,
