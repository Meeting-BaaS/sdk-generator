...
pub struct CallbackLivePostFinalTranscriptMessage {
    ...
    pub payload: Box<models::PostFinalTranscriptMessage>,
}

impl CallbackLivePostFinalTranscriptMessage {
    pub fn new(id: uuid::Uuid, event: Event, payload: models::PostFinalTranscriptMessage) -> CallbackLivePostFinalTranscriptMessage {
