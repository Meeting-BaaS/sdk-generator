...
pub struct PostFinalTranscriptMessage {
    ...
    /// The message data
    #[serde(rename = "data")]
    pub data: Box<models::StreamingTranscriptionResultDto>,
}

impl PostFinalTranscriptMessage {
    pub fn new(session_id: String, created_at: String, r#type: Type, data: models::StreamingTranscriptionResultDto) -> PostFinalTranscriptMessage {
