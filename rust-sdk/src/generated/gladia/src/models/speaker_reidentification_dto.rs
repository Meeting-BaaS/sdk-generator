...
pub struct SpeakerReidentificationDto {
...
impl SpeakerReidentificationDto {
    pub fn new(success: bool, is_empty: bool, exec_time: f64, error: models::AddonErrorDto, results: String) -> SpeakerReidentificationDto {
