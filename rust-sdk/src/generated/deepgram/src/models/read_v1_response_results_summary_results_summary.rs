...
pub struct ReadV1ResponseResultsSummaryResultsSummary {
    #[serde(rename = "text", skip_serializing_if = "Option::is_none")]
    pub text: Option<String>,
}

impl ReadV1ResponseResultsSummaryResultsSummary {
    pub fn new() -> ReadV1ResponseResultsSummaryResultsSummary {
