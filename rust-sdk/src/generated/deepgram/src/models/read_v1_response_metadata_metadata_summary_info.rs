...
pub struct ReadV1ResponseMetadataMetadataSummaryInfo {
    #[serde(rename = "model_uuid", skip_serializing_if = "Option::is_none")]
    pub model_uuid: Option<uuid::Uuid>,
...
impl ReadV1ResponseMetadataMetadataSummaryInfo {
    pub fn new() -> ReadV1ResponseMetadataMetadataSummaryInfo {
