...
export const getFileUrl = <TData = AxiosResponse<FileUrl>>(
  ...
  return axios.get(`/v1/files/${fileId}/url`, options)
}
...
export const getGetFileUrlResponseMock = (overrideResponse: Partial<FileUrl> = {}): FileUrl => ({
...
export const getGetFileUrlMockHandler = (
  overrideResponse?:
    | FileUrl
    | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<FileUrl> | FileUrl)
) => {
  return http.get("https://api.soniox.com/v1/files/:fileId/url", async (info) => {
    await delay(1000)
