...
export const getGetFilesCountResponseMock = (overrideResponse: Partial< GetFilesCountResponse > = {}): GetFilesCountResponse => ({total: faker.number.int({min: undefined, max: undefined}), public_api: faker.number.int({min: undefined, max: undefined}), playground: faker.number.int({min: undefined, max: undefined}), ...overrideResponse})
...
export const getGetTranscriptionsCountResponseMock = (overrideResponse: Partial< GetTranscriptionsCountResponse > = {}): GetTranscriptionsCountResponse => ({total: faker.number.int({min: undefined, max: undefined}), public_api: faker.number.int({min: undefined, max: undefined}), playground: faker.number.int({min: undefined, max: undefined}), ...overrideResponse})
...
export const getGetFilesCountMockHandler = (overrideResponse?: GetFilesCountResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<GetFilesCountResponse> | GetFilesCountResponse)) => {
  return http.get('https://api.soniox.com/v1/files/count', async (info) => {await delay(1000);
...
export const getGetTranscriptionsCountMockHandler = (overrideResponse?: GetTranscriptionsCountResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<GetTranscriptionsCountResponse> | GetTranscriptionsCountResponse)) => {
  return http.get('https://api.soniox.com/v1/transcriptions/count', async (info) => {await delay(1000);
