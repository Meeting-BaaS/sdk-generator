...
export const createTemporaryApiKeyBody = zod.object({
  ...
  single_use: zod
    ...
    .or(zod.null())
    .optional()
    .describe("If true, the temporary API key can be used only once."),
  max_session_duration_seconds: zod
    .number()
    .min(1)
    .max(createTemporaryApiKeyBodyMaxSessionDurationSecondsMaxOne)
    .or(zod.null())
    .optional()
    .describe(
