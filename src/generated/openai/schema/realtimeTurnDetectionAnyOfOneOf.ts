 ...
 */
import type { RealtimeTurnDetectionAnyOfOneOfIdleTimeoutMs } from './realtimeTurnDetectionAnyOfOneOfIdleTimeoutMs';

/**
 * Server-side voice activity detection (VAD) which flips on when user speech is detected and off after a period of silence.
 */
export type RealtimeTurnDetectionAnyOfOneOf = {
 ...
 */
  ...
  idle_timeout_ms?: RealtimeTurnDetectionAnyOfOneOfIdleTimeoutMs;
};
