...
export const CreateSpeechResponse = zod.unknown()
...
export const createTranscriptionBodyChunkingStrategyOneOneDefault = `auto`;
export const createTranscriptionBodyChunkingStrategyOneTwoPrefixPaddingMsDefault = 300;
export const createTranscriptionBodyChunkingStrategyOneTwoSilenceDurationMsDefault = 200;
export const createTranscriptionBodyChunkingStrategyOneTwoThresholdDefault = 0.5;
...
export const CreateTranscriptionBody = zod.object({
  ...
  "silence_duration_ms": zod.number().default(createTranscriptionBodyChunkingStrategyOneTwoSilenceDurationMsDefault).describe('Duration of silence to detect speech stop (in milliseconds).\nWith shorter values the model will respond more quickly, \nbut may jump in on short pauses from the user.\n'),
  "threshold": zod.number().default(createTranscriptionBodyChunkingStrategyOneTwoThresholdDefault).describe('Sensitivity threshold (0.0 to 1.0) for voice activity detection. A \nhigher threshold will require louder audio to activate the model, and \nthus might perform better in noisy environments.\n')
})]).describe('Controls how the audio is cut into chunks. When set to `\"auto\"`, the server first normalizes loudness and then uses voice activity detection (VAD) to choose boundaries. `server_vad` object can be provided to tweak VAD detection parameters manually. If unset, the audio is transcribed as a single block. Required when using `gpt-4o-transcribe-diarize` for inputs longer than 30 seconds. '),zod.null()]).optional(),
...
export const CreateTranslationResponse = zod.union([zod.object({
  "text": zod.string()
}),zod.object({
...
export const createRealtimeClientSecretBodySessionOneAudioInputTurnDetectionOneOneInterruptResponseDefault = true;
export const createRealtimeClientSecretBodySessionOneAudioInputTurnDetectionOneOneIdleTimeoutMsOneMin = 5000;
export const createRealtimeClientSecretBodySessionOneAudioInputTurnDetectionOneOneIdleTimeoutMsOneMax = 30000;

export const createRealtimeClientSecretBodySessionOneAudioInputTurnDetectionOneTwoEagernessDefault = `auto`;
export const createRealtimeClientSecretBodySessionOneAudioInputTurnDetectionOneTwoCreateResponseDefault = true;
export const createRealtimeClientSecretBodySessionOneAudioInputTurnDetectionOneTwoInterruptResponseDefault = true;
export const createRealtimeClientSecretBodySessionOneAudioOutputVoiceDefault = `alloy`;
export const createRealtimeClientSecretBodySessionOneAudioOutputSpeedDefault = 1;
export const createRealtimeClientSecretBodySessionOneAudioOutputSpeedMin = 0.25;
export const createRealtimeClientSecretBodySessionOneAudioOutputSpeedMax = 1.5;

export const createRealtimeClientSecretBodySessionOneTracingOneDefault = `auto`;
export const createRealtimeClientSecretBodySessionOneTracingDefault = null;
export const createRealtimeClientSecretBodySessionOneToolsItemTwoTunnelIdRegExp = new RegExp('^tunnel_[a-z0-9]{32}$');

export const createRealtimeClientSecretBodySessionOneToolsItemTwoRequireApprovalOneDefault = `always`;
export const createRealtimeClientSecretBodySessionOneToolChoiceDefault = `auto`;
export const createRealtimeClientSecretBodySessionOneReasoningEffortDefault = `low`;
export const createRealtimeClientSecretBodySessionOneTruncationTwoRetentionRatioMin = 0;
export const createRealtimeClientSecretBodySessionOneTruncationTwoRetentionRatioMax = 1;

export const createRealtimeClientSecretBodySessionOneTruncationTwoTokenLimitsPostInstructionsMin = 0;

export const createRealtimeClientSecretBodySessionOnePromptOneVariablesOneTwoTypeDefault = `input_text`;
export const createRealtimeClientSecretBodySessionOnePromptOneVariablesOneTwoPromptCacheBreakpointModeDefault = `explicit`;
export const createRealtimeClientSecretBodySessionOnePromptOneVariablesOneThreeTypeDefault = `input_image`;
export const createRealtimeClientSecretBodySessionOnePromptOneVariablesOneThreePromptCacheBreakpointModeDefault = `explicit`;
export const createRealtimeClientSecretBodySessionOnePromptOneVariablesOneFourTypeDefault = `input_file`;
export const createRealtimeClientSecretBodySessionOnePromptOneVariablesOneFourPromptCacheBreakpointModeDefault = `explicit`;
export const createRealtimeClientSecretBodySessionTwoAudioInputNoiseReductionDefault = null;
export const createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneOneTypeDefault = `server_vad`;
export const createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneOneCreateResponseDefault = true;
export const createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneOneInterruptResponseDefault = true;
export const createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneOneIdleTimeoutMsOneMin = 5000;
export const createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneOneIdleTimeoutMsOneMax = 30000;

export const createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneTwoEagernessDefault = `auto`;
export const createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneTwoCreateResponseDefault = true;
export const createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneTwoInterruptResponseDefault = true;
...
export const CreateRealtimeClientSecretBody = zod.object({
  ...
  "output_modalities": zod.array(zod.enum(['text', 'audio'])).default([`audio`]).describe('The set of modalities the model can respond with. It defaults to `[\"audio\"]`, indicating\nthat the model will respond with audio plus a transcript. `[\"text\"]` can be used to make\nthe model respond with text only. It is not possible to request both `text` and `audio` at the same time.\n'),
  "model": zod.union([zod.string(),zod.enum(['gpt-realtime', 'gpt-realtime-1.5', 'gpt-realtime-2', 'gpt-realtime-2.1', 'gpt-realtime-2.1-mini', 'gpt-realtime-2025-08-28', 'gpt-4o-realtime-preview', 'gpt-4o-realtime-preview-2024-10-01', 'gpt-4o-realtime-preview-2024-12-17', 'gpt-4o-realtime-preview-2025-06-03', 'gpt-4o-mini-realtime-preview', 'gpt-4o-mini-realtime-preview-2024-12-17', 'gpt-realtime-mini', 'gpt-realtime-mini-2025-10-06', 'gpt-realtime-mini-2025-12-15', 'gpt-audio-1.5', 'gpt-audio-mini', 'gpt-audio-mini-2025-10-06', 'gpt-audio-mini-2025-12-15'])]).optional().describe('The Realtime model used for this session.\n'),
  ...
  "turn_detection": zod.union([zod.union([zod.object({
  "type": zod.literal("server_vad").default(createRealtimeClientSecretBodySessionOneAudioInputTurnDetectionOneOneTypeDefault).describe('Type of turn detection, `server_vad` to turn on simple Server VAD.\n'),
  ...
  "create_response": zod.boolean().default(createRealtimeClientSecretBodySessionOneAudioInputTurnDetectionOneOneCreateResponseDefault).describe('Whether or not to automatically generate a response when a VAD stop event occurs. If `interrupt_response` is set to `false` this may fail to create a response if the model is already responding.\n\nIf both `create_response` and `interrupt_response` are set to `false`, the model will never respond automatically but VAD events will still be emitted.\n'),
  "interrupt_response": zod.boolean().default(createRealtimeClientSecretBodySessionOneAudioInputTurnDetectionOneOneInterruptResponseDefault).describe('Whether or not to automatically interrupt (cancel) any ongoing response with output to the default\nconversation (i.e. `conversation` of `auto`) when a VAD start event occurs. If `true` then the response will be cancelled, otherwise it will continue until complete.\n\nIf both `create_response` and `interrupt_response` are set to `false`, the model will never respond automatically but VAD events will still be emitted.\n'),
  "idle_timeout_ms": zod.union([zod.number().min(createRealtimeClientSecretBodySessionOneAudioInputTurnDetectionOneOneIdleTimeoutMsOneMin).max(createRealtimeClientSecretBodySessionOneAudioInputTurnDetectionOneOneIdleTimeoutMsOneMax).describe('Optional timeout after which a model response will be triggered automatically. This is\nuseful for situations in which a long pause from the user is unexpected, such as a phone\ncall. The model will effectively prompt the user to continue the conversation based\non the current context.\n\nThe timeout value will be applied after the last model response\'s audio has finished playing,\ni.e. it\'s set to the `response.done` time plus audio playback duration.\n\nAn `input_audio_buffer.timeout_triggered` event (plus events\nassociated with the Response) will be emitted when the timeout is reached.\nIdle timeout is currently only supported for `server_vad` mode.\n'),zod.null()]).optional()
  ...
  "type": zod.literal("semantic_vad").describe('Type of turn detection, `semantic_vad` to turn on Semantic VAD.\n'),
  "eagerness": zod.enum(['low', 'medium', 'high', 'auto']).default(createRealtimeClientSecretBodySessionOneAudioInputTurnDetectionOneTwoEagernessDefault).describe('Used only for `semantic_vad` mode. The eagerness of the model to respond. `low` will wait longer for the user to continue speaking, `high` will respond more quickly. `auto` is the default and is equivalent to `medium`. `low`, `medium`, and `high` have max timeouts of 8s, 4s, and 2s respectively.\n'),
  "create_response": zod.boolean().default(createRealtimeClientSecretBodySessionOneAudioInputTurnDetectionOneTwoCreateResponseDefault).describe('Whether or not to automatically generate a response when a VAD stop event occurs.\n'),
  "interrupt_response": zod.boolean().default(createRealtimeClientSecretBodySessionOneAudioInputTurnDetectionOneTwoInterruptResponseDefault).describe('Whether or not to automatically interrupt any ongoing response with output to the default\nconversation (i.e. `conversation` of `auto`) when a VAD start event occurs.\n')
  ...
  "type": zod.enum(['audio/pcma']).optional().describe('The audio format. Always `audio\/pcma`.')
}).describe('The G.711 A-law format.')]).optional().describe('The format of the output audio.'),
  "voice": zod.union([zod.union([zod.string(),zod.enum(['alloy', 'ash', 'ballad', 'coral', 'echo', 'sage', 'shimmer', 'verse', 'marin', 'cedar'])]),zod.object({
  "id": zod.string().describe('The custom voice ID, e.g. `voice_1234`.')
}).describe('Custom voice reference.')]).default(createRealtimeClientSecretBodySessionOneAudioOutputVoiceDefault).describe('The voice the model uses to respond. Supported built-in voices are\n`alloy`, `ash`, `ballad`, `coral`, `echo`, `sage`, `shimmer`, `verse`,\n`marin`, and `cedar`. You may also provide a custom voice object with\nan `id`, for example `{ \"id\": \"voice_1234\" }`. Voice cannot be changed\nduring the session once the model has responded with audio at least once.\nWe recommend `marin` and `cedar` for best quality.\n'),
  "speed": zod.number().min(createRealtimeClientSecretBodySessionOneAudioOutputSpeedMin).max(createRealtimeClientSecretBodySessionOneAudioOutputSpeedMax).default(createRealtimeClientSecretBodySessionOneAudioOutputSpeedDefault).describe('The speed of the model\'s spoken response as a multiple of the original speed.\n1.0 is the default speed. 0.25 is the minimum speed. 1.5 is the maximum speed. This value can only be changed in between model turns, not while a response is in progress.\n\nThis parameter is a post-processing adjustment to the audio after it is generated, it\'s\nalso possible to prompt the model to speak faster or slower.\n')
}).optional()
  ...
  "tracing": zod.union([zod.enum(['auto']).default(createRealtimeClientSecretBodySessionOneTracingOneDefault).describe('Enables tracing and sets default values for tracing configuration options. Always `auto`.\n'),zod.object({
...
}).describe('Granular configuration for tracing.\n')]).nullish().default(createRealtimeClientSecretBodySessionOneTracingDefault).describe('Realtime API can write session traces to the [Traces Dashboard](https:\/\/platform.openai.com\/logs?api=traces). Set to null to disable tracing. Once\ntracing is enabled for a session, the configuration cannot be modified.\n\n`auto` will create a trace for the session with default values for the\nworkflow name, group id, and metadata.\n'),
  ...
  "headers": zod.union([zod.record(zod.string(), zod.string()).describe('Optional HTTP headers to send to the MCP server. Use for authentication\nor other purposes.\n'),zod.null()]).optional(),
  "allowed_tools": zod.union([zod.union([zod.array(zod.string()).describe('A string array of allowed tool names'),zod.object({
  ...
  "allowed_callers": zod.union([zod.array(zod.enum(['direct', 'programmatic'])).min(1).describe('The tool invocation context(s).'),zod.null()]).optional(),
  "require_approval": zod.union([zod.union([zod.object({
  "always": zod.object({
  "tool_names": zod.array(zod.string()).optional().describe('List of allowed tool names.'),
  "read_only": zod.boolean().optional().describe('Indicates whether or not a tool modifies data or is read-only. If an\nMCP server is [annotated with `readOnlyHint`](https:\/\/modelcontextprotocol.io\/specification\/2025-06-18\/schema#toolannotations-readonlyhint),\nit will match this filter.\n')
  ...
  "name": zod.union([zod.string().describe('The name of the tool to call on the server.\n'),zod.null()]).optional()
}).describe('Use this option to force the model to call a specific tool on a remote MCP server.\n')]).default(createRealtimeClientSecretBodySessionOneToolChoiceDefault).describe('How the model chooses tools. Provide one of the string modes or force a specific\nfunction\/MCP tool.\n'),
  "parallel_tool_calls": zod.boolean().optional().describe('Whether the model may call multiple tools in parallel. Only supported by\nreasoning Realtime models such as `gpt-realtime-2`.\n'),
  "reasoning": zod.object({
  "effort": zod.enum(['minimal', 'low', 'medium', 'high', 'xhigh']).default(createRealtimeClientSecretBodySessionOneReasoningEffortDefault).describe('Constrains effort on reasoning for reasoning-capable Realtime models such as\n`gpt-realtime-2`.\n')
}).optional().describe('Configuration for reasoning-capable Realtime models such as `gpt-realtime-2`.\n'),
  "max_output_tokens": zod.union([zod.number(),zod.enum(['inf'])]).optional().describe('Maximum number of output tokens for a single assistant response,\ninclusive of tool calls. Provide an integer between 1 and 4096 to\nlimit output tokens, or `inf` for the maximum available tokens for a\ngiven model. Defaults to `inf`.\n'),
  "truncation": zod.union([zod.enum(['auto', 'disabled']).describe('The truncation strategy to use for the session. `auto` is the default truncation strategy. `disabled` will disable truncation and emit errors when the conversation exceeds the input token limit.'),zod.object({
  "type": zod.enum(['retention_ratio']).describe('Use retention ratio truncation.'),
  "retention_ratio": zod.number().min(createRealtimeClientSecretBodySessionOneTruncationTwoRetentionRatioMin).max(createRealtimeClientSecretBodySessionOneTruncationTwoRetentionRatioMax).describe('Fraction of post-instruction conversation tokens to retain (`0.0` - `1.0`) when the conversation exceeds the input token limit. Setting this to `0.8` means that messages will be dropped until 80% of the maximum allowed tokens are used. This helps reduce the frequency of truncations and improve cache rates.\n'),
  "token_limits": zod.object({
  "post_instructions": zod.number().min(createRealtimeClientSecretBodySessionOneTruncationTwoTokenLimitsPostInstructionsMin).optional().describe('Maximum tokens allowed in the conversation after instructions (which including tool definitions). For example, setting this to 5,000 would mean that truncation would occur when the conversation exceeds 5,000 tokens after instructions. This cannot be higher than the model\'s context window size minus the maximum output tokens.')
  ...
  "version": zod.union([zod.string().describe('Optional version of the prompt template.'),zod.null()]).optional(),
  "variables": zod.union([zod.record(zod.string(), zod.union([zod.string(),zod.object({
  "type": zod.enum(['input_text']).default(createRealtimeClientSecretBodySessionOnePromptOneVariablesOneTwoTypeDefault).describe('The type of the input item. Always `input_text`.'),
  "text": zod.string().describe('The text input to the model.'),
  "prompt_cache_breakpoint": zod.object({
  "mode": zod.enum(['explicit']).default(createRealtimeClientSecretBodySessionOnePromptOneVariablesOneTwoPromptCacheBreakpointModeDefault).describe('The breakpoint mode. Always `explicit`.')
  ...
  "type": zod.enum(['input_image']).default(createRealtimeClientSecretBodySessionOnePromptOneVariablesOneThreeTypeDefault).describe('The type of the input item. Always `input_image`.'),
  "image_url": zod.union([zod.url().describe('The URL of the image to be sent to the model. A fully qualified URL or base64 encoded image in a data URL.'),zod.null()]).optional(),
  "file_id": zod.union([zod.string().describe('The ID of the file to be sent to the model.'),zod.null()]).optional(),
  "detail": zod.enum(['low', 'high', 'auto', 'original']).describe('The detail level of the image to be sent to the model. One of `high`, `low`, `auto`, or `original`. Defaults to `auto`.'),
  "prompt_cache_breakpoint": zod.object({
  ...
  "prompt_cache_breakpoint": zod.object({
  "mode": zod.enum(['explicit']).default(createRealtimeClientSecretBodySessionOnePromptOneVariablesOneFourPromptCacheBreakpointModeDefault).describe('The breakpoint mode. Always `explicit`.')
}).optional().describe('Marks the exact end of a reusable prompt prefix. The breakpoint inherits its TTL from the request\'s `prompt_cache_options.ttl`; the boundary is not rounded to a token block.'),
  ...
  "turn_detection": zod.union([zod.union([zod.object({
  "type": zod.literal("server_vad").default(createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneOneTypeDefault).describe('Type of turn detection, `server_vad` to turn on simple Server VAD.\n'),
  "threshold": zod.number().optional().describe('Used only for `server_vad` mode. Activation threshold for VAD (0.0 to 1.0), this defaults to 0.5. A\nhigher threshold will require louder audio to activate the model, and\nthus might perform better in noisy environments.\n'),
  "prefix_padding_ms": zod.number().optional().describe('Used only for `server_vad` mode. Amount of audio to include before the VAD detected speech (in\nmilliseconds). Defaults to 300ms.\n'),
  "silence_duration_ms": zod.number().optional().describe('Used only for `server_vad` mode. Duration of silence to detect speech stop (in milliseconds). Defaults\nto 500ms. With shorter values the model will respond more quickly,\nbut may jump in on short pauses from the user.\n'),
  "create_response": zod.boolean().default(createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneOneCreateResponseDefault).describe('Whether or not to automatically generate a response when a VAD stop event occurs. If `interrupt_response` is set to `false` this may fail to create a response if the model is already responding.\n\nIf both `create_response` and `interrupt_response` are set to `false`, the model will never respond automatically but VAD events will still be emitted.\n'),
  "interrupt_response": zod.boolean().default(createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneOneInterruptResponseDefault).describe('Whether or not to automatically interrupt (cancel) any ongoing response with output to the default\nconversation (i.e. `conversation` of `auto`) when a VAD start event occurs. If `true` then the response will be cancelled, otherwise it will continue until complete.\n\nIf both `create_response` and `interrupt_response` are set to `false`, the model will never respond automatically but VAD events will still be emitted.\n'),
  "idle_timeout_ms": zod.union([zod.number().min(createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneOneIdleTimeoutMsOneMin).max(createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneOneIdleTimeoutMsOneMax).describe('Optional timeout after which a model response will be triggered automatically. This is\nuseful for situations in which a long pause from the user is unexpected, such as a phone\ncall. The model will effectively prompt the user to continue the conversation based\non the current context.\n\nThe timeout value will be applied after the last model response\'s audio has finished playing,\ni.e. it\'s set to the `response.done` time plus audio playback duration.\n\nAn `input_audio_buffer.timeout_triggered` event (plus events\nassociated with the Response) will be emitted when the timeout is reached.\nIdle timeout is currently only supported for `server_vad` mode.\n'),zod.null()]).optional()
}).describe('Server-side voice activity detection (VAD) which flips on when user speech is detected and off after a period of silence.'),zod.object({
  "type": zod.literal("semantic_vad").describe('Type of turn detection, `semantic_vad` to turn on Semantic VAD.\n'),
  "eagerness": zod.enum(['low', 'medium', 'high', 'auto']).default(createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneTwoEagernessDefault).describe('Used only for `semantic_vad` mode. The eagerness of the model to respond. `low` will wait longer for the user to continue speaking, `high` will respond more quickly. `auto` is the default and is equivalent to `medium`. `low`, `medium`, and `high` have max timeouts of 8s, 4s, and 2s respectively.\n'),
  "create_response": zod.boolean().default(createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneTwoCreateResponseDefault).describe('Whether or not to automatically generate a response when a VAD stop event occurs.\n'),
  "interrupt_response": zod.boolean().default(createRealtimeClientSecretBodySessionTwoAudioInputTurnDetectionOneTwoInterruptResponseDefault).describe('Whether or not to automatically interrupt any ongoing response with output to the default\nconversation (i.e. `conversation` of `auto`) when a VAD start event occurs.\n')
}).describe('Server-side semantic turn detection which uses a model to determine when the user has finished speaking.')]).describe('Configuration for turn detection, ether Server VAD or Semantic VAD. This can be set to `null` to turn off, in which case the client must manually trigger model response.\n\nServer VAD means that the model will detect the start and end of speech based on audio volume and respond at the end of user speech.\n\nSemantic VAD is more advanced and uses a turn detection model (in conjunction with VAD) to semantically estimate whether the user has finished speaking, then dynamically sets a timeout based on this probability. For example, if user audio trails off with \"uhhm\", the model will score a low probability of turn end and wait longer for the user to continue speaking. This can be useful for more natural conversations, but may have a higher latency.\n\nFor `gpt-realtime-whisper` transcription sessions, turn detection must be\nset to `null`; VAD is not supported.\n'),zod.null()]).optional()
}).optional()
}).optional().describe('Configuration for input and output audio.\n'),
  "include": zod.array(zod.enum(['item.input_audio_transcription.logprobs'])).optional().describe('Additional fields to include in server outputs.\n\n`item.input_audio_transcription.logprobs`: Include logprobs for input audio transcription.\n')
...
export const createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneOneCreateResponseDefault = true;
export const createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneOneInterruptResponseDefault = true;
export const createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneOneIdleTimeoutMsOneMin = 5000;
export const createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneOneIdleTimeoutMsOneMax = 30000;

export const createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneTwoEagernessDefault = `auto`;
export const createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneTwoCreateResponseDefault = true;
export const createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneTwoInterruptResponseDefault = true;
export const createRealtimeClientSecretResponseSessionOneAudioOutputVoiceDefault = `alloy`;
export const createRealtimeClientSecretResponseSessionOneAudioOutputSpeedDefault = 1;
export const createRealtimeClientSecretResponseSessionOneAudioOutputSpeedMin = 0.25;
export const createRealtimeClientSecretResponseSessionOneAudioOutputSpeedMax = 1.5;

export const createRealtimeClientSecretResponseSessionOneTracingOneOneDefault = `auto`;
export const createRealtimeClientSecretResponseSessionOneTracingOneDefault = null;
export const createRealtimeClientSecretResponseSessionOneToolsItemTwoTunnelIdRegExp = new RegExp('^tunnel_[a-z0-9]{32}$');

export const createRealtimeClientSecretResponseSessionOneToolsItemTwoRequireApprovalOneDefault = `always`;
export const createRealtimeClientSecretResponseSessionOneToolChoiceDefault = `auto`;
export const createRealtimeClientSecretResponseSessionOneReasoningEffortDefault = `low`;
export const createRealtimeClientSecretResponseSessionOneTruncationTwoRetentionRatioMin = 0;
export const createRealtimeClientSecretResponseSessionOneTruncationTwoRetentionRatioMax = 1;

export const createRealtimeClientSecretResponseSessionOneTruncationTwoTokenLimitsPostInstructionsMin = 0;

export const createRealtimeClientSecretResponseSessionOnePromptOneVariablesOneTwoTypeDefault = `input_text`;
export const createRealtimeClientSecretResponseSessionOnePromptOneVariablesOneTwoPromptCacheBreakpointModeDefault = `explicit`;
export const createRealtimeClientSecretResponseSessionOnePromptOneVariablesOneThreeTypeDefault = `input_image`;
export const createRealtimeClientSecretResponseSessionOnePromptOneVariablesOneThreePromptCacheBreakpointModeDefault = `explicit`;
...
export const CreateRealtimeClientSecretResponse = zod.object({
  ...
  "object": zod.enum(['realtime.session']).describe('The object type. Always `realtime.session`.'),
  ...
  "turn_detection": zod.union([zod.union([zod.object({
  "type": zod.literal("server_vad").default(createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneOneTypeDefault).describe('Type of turn detection, `server_vad` to turn on simple Server VAD.\n'),
  "threshold": zod.number().optional().describe('Used only for `server_vad` mode. Activation threshold for VAD (0.0 to 1.0), this defaults to 0.5. A\nhigher threshold will require louder audio to activate the model, and\nthus might perform better in noisy environments.\n'),
  "prefix_padding_ms": zod.number().optional().describe('Used only for `server_vad` mode. Amount of audio to include before the VAD detected speech (in\nmilliseconds). Defaults to 300ms.\n'),
  "silence_duration_ms": zod.number().optional().describe('Used only for `server_vad` mode. Duration of silence to detect speech stop (in milliseconds). Defaults\nto 500ms. With shorter values the model will respond more quickly,\nbut may jump in on short pauses from the user.\n'),
  "create_response": zod.boolean().default(createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneOneCreateResponseDefault).describe('Whether or not to automatically generate a response when a VAD stop event occurs. If `interrupt_response` is set to `false` this may fail to create a response if the model is already responding.\n\nIf both `create_response` and `interrupt_response` are set to `false`, the model will never respond automatically but VAD events will still be emitted.\n'),
  "interrupt_response": zod.boolean().default(createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneOneInterruptResponseDefault).describe('Whether or not to automatically interrupt (cancel) any ongoing response with output to the default\nconversation (i.e. `conversation` of `auto`) when a VAD start event occurs. If `true` then the response will be cancelled, otherwise it will continue until complete.\n\nIf both `create_response` and `interrupt_response` are set to `false`, the model will never respond automatically but VAD events will still be emitted.\n'),
  "idle_timeout_ms": zod.union([zod.number().min(createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneOneIdleTimeoutMsOneMin).max(createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneOneIdleTimeoutMsOneMax).describe('Optional timeout after which a model response will be triggered automatically. This is\nuseful for situations in which a long pause from the user is unexpected, such as a phone\ncall. The model will effectively prompt the user to continue the conversation based\non the current context.\n\nThe timeout value will be applied after the last model response\'s audio has finished playing,\ni.e. it\'s set to the `response.done` time plus audio playback duration.\n\nAn `input_audio_buffer.timeout_triggered` event (plus events\nassociated with the Response) will be emitted when the timeout is reached.\nIdle timeout is currently only supported for `server_vad` mode.\n'),zod.null()]).optional()
}).describe('Server-side voice activity detection (VAD) which flips on when user speech is detected and off after a period of silence.'),zod.object({
  "type": zod.literal("semantic_vad").describe('Type of turn detection, `semantic_vad` to turn on Semantic VAD.\n'),
  "eagerness": zod.enum(['low', 'medium', 'high', 'auto']).default(createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneTwoEagernessDefault).describe('Used only for `semantic_vad` mode. The eagerness of the model to respond. `low` will wait longer for the user to continue speaking, `high` will respond more quickly. `auto` is the default and is equivalent to `medium`. `low`, `medium`, and `high` have max timeouts of 8s, 4s, and 2s respectively.\n'),
  "create_response": zod.boolean().default(createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneTwoCreateResponseDefault).describe('Whether or not to automatically generate a response when a VAD stop event occurs.\n'),
  "interrupt_response": zod.boolean().default(createRealtimeClientSecretResponseSessionOneAudioInputTurnDetectionOneTwoInterruptResponseDefault).describe('Whether or not to automatically interrupt any ongoing response with output to the default\nconversation (i.e. `conversation` of `auto`) when a VAD start event occurs.\n')
}).describe('Server-side semantic turn detection which uses a model to determine when the user has finished speaking.')]).describe('Configuration for turn detection, ether Server VAD or Semantic VAD. This can be set to `null` to turn off, in which case the client must manually trigger model response.\n\nServer VAD means that the model will detect the start and end of speech based on audio volume and respond at the end of user speech.\n\nSemantic VAD is more advanced and uses a turn detection model (in conjunction with VAD) to semantically estimate whether the user has finished speaking, then dynamically sets a timeout based on this probability. For example, if user audio trails off with \"uhhm\", the model will score a low probability of turn end and wait longer for the user to continue speaking. This can be useful for more natural conversations, but may have a higher latency.\n\nFor `gpt-realtime-whisper` transcription sessions, turn detection must be\nset to `null`; VAD is not supported.\n'),zod.null()]).optional()
}).optional(),
  "output": zod.object({
  "format": zod.union([zod.object({
  ...
  "voice": zod.union([zod.string(),zod.enum(['alloy', 'ash', 'ballad', 'coral', 'echo', 'sage', 'shimmer', 'verse', 'marin', 'cedar'])]).default(createRealtimeClientSecretResponseSessionOneAudioOutputVoiceDefault).describe('The voice the model uses to respond. Voice cannot be changed during the\nsession once the model has responded with audio at least once. Current\nvoice options are `alloy`, `ash`, `ballad`, `coral`, `echo`, `sage`,\n`shimmer`, `verse`, `marin`, and `cedar`. We recommend `marin` and `cedar` for\nbest quality.\n'),
  "speed": zod.number().min(createRealtimeClientSecretResponseSessionOneAudioOutputSpeedMin).max(createRealtimeClientSecretResponseSessionOneAudioOutputSpeedMax).default(createRealtimeClientSecretResponseSessionOneAudioOutputSpeedDefault).describe('The speed of the model\'s spoken response as a multiple of the original speed.\n1.0 is the default speed. 0.25 is the minimum speed. 1.5 is the maximum speed. This value can only be changed in between model turns, not while a response is in progress.\n\nThis parameter is a post-processing adjustment to the audio after it is generated, it\'s\nalso possible to prompt the model to speak faster or slower.\n')
}).optional()
}).optional().describe('Configuration for input and output audio.\n'),
  "include": zod.array(zod.enum(['item.input_audio_transcription.logprobs'])).optional().describe('Additional fields to include in server outputs.\n\n`item.input_audio_transcription.logprobs`: Include logprobs for input audio transcription.\n'),
  "tracing": zod.union([zod.union([zod.enum(['auto']).default(createRealtimeClientSecretResponseSessionOneTracingOneOneDefault).describe('Enables tracing and sets default values for tracing configuration options. Always `auto`.\n'),zod.object({
  "workflow_name": zod.string().optional().describe('The name of the workflow to attach to this trace. This is used to\nname the trace in the Traces Dashboard.\n'),
  "group_id": zod.string().optional().describe('The group id to attach to this trace to enable filtering and\ngrouping in the Traces Dashboard.\n'),
  "metadata": zod.looseObject({

}).optional().describe('The arbitrary metadata to attach to this trace to enable\nfiltering in the Traces Dashboard.\n')
}).describe('Granular configuration for tracing.\n')]).nullable().default(createRealtimeClientSecretResponseSessionOneTracingOneDefault).describe('Realtime API can write session traces to the [Traces Dashboard](https:\/\/platform.openai.com\/logs?api=traces). Set to null to disable tracing. Once\ntracing is enabled for a session, the configuration cannot be modified.\n\n`auto` will create a trace for the session with default values for the\nworkflow name, group id, and metadata.\n'),zod.null()]).optional(),
  "tools": zod.array(zod.union([zod.object({
  "type": zod.enum(['function']).optional().describe('The type of the tool, i.e. `function`.'),
  "name": zod.string().optional().describe('The name of the function.'),
  "description": zod.string().optional().describe('The description of the function, including guidance on when and how\nto call it, and guidance about what to tell the user when calling\n(if anything).\n'),
  ...
  "server_label": zod.string().describe('The label of the MCP server to use.\n'),
  "name": zod.union([zod.string().describe('The name of the tool to call on the server.\n'),zod.null()]).optional()
}).describe('Use this option to force the model to call a specific tool on a remote MCP server.\n')]).default(createRealtimeClientSecretResponseSessionOneToolChoiceDefault).describe('How the model chooses tools. Provide one of the string modes or force a specific\nfunction\/MCP tool.\n'),
  "reasoning": zod.object({
  "effort": zod.enum(['minimal', 'low', 'medium', 'high', 'xhigh']).default(createRealtimeClientSecretResponseSessionOneReasoningEffortDefault).describe('Constrains effort on reasoning for reasoning-capable Realtime models such as\n`gpt-realtime-2`.\n')
}).optional().describe('Configuration for reasoning-capable Realtime models such as `gpt-realtime-2`.\n'),
  "max_output_tokens": zod.union([zod.number(),zod.enum(['inf'])]).optional().describe('Maximum number of output tokens for a single assistant response,\ninclusive of tool calls. Provide an integer between 1 and 4096 to\nlimit output tokens, or `inf` for the maximum available tokens for a\ngiven model. Defaults to `inf`.\n'),
  "truncation": zod.union([zod.enum(['auto', 'disabled']).describe('The truncation strategy to use for the session. `auto` is the default truncation strategy. `disabled` will disable truncation and emit errors when the conversation exceeds the input token limit.'),zod.object({
  "type": zod.enum(['retention_ratio']).describe('Use retention ratio truncation.'),
  "retention_ratio": zod.number().min(createRealtimeClientSecretResponseSessionOneTruncationTwoRetentionRatioMin).max(createRealtimeClientSecretResponseSessionOneTruncationTwoRetentionRatioMax).describe('Fraction of post-instruction conversation tokens to retain (`0.0` - `1.0`) when the conversation exceeds the input token limit. Setting this to `0.8` means that messages will be dropped until 80% of the maximum allowed tokens are used. This helps reduce the frequency of truncations and improve cache rates.\n'),
  "token_limits": zod.object({
  "post_instructions": zod.number().min(createRealtimeClientSecretResponseSessionOneTruncationTwoTokenLimitsPostInstructionsMin).optional().describe('Maximum tokens allowed in the conversation after instructions (which including tool definitions). For example, setting this to 5,000 would mean that truncation would occur when the conversation exceeds 5,000 tokens after instructions. This cannot be higher than the model\'s context window size minus the maximum output tokens.')
}).optional().describe('Optional custom token limits for this truncation strategy. If not provided, the model\'s default token limits will be used.')
}).describe('Retain a fraction of the conversation tokens when the conversation exceeds the input token limit. This allows you to amortize truncations across multiple turns, which can help improve cached token usage.')]).optional().describe('When the number of tokens in a conversation exceeds the model\'s input token limit, the conversation be truncated, meaning messages (starting from the oldest) will not be included in the model\'s context. A 32k context model with 4,096 max output tokens can only include 28,224 tokens in the context before truncation occurs.\n\nClients can configure truncation behavior to truncate with a lower max token limit, which is an effective way to control token usage and cost.\n\nTruncation will reduce the number of cached tokens on the next turn (busting the cache), since messages are dropped from the beginning of the context. However, clients can also configure truncation to retain messages up to a fraction of the maximum context size, which will reduce the need for future truncations and thus improve the cache rate.\n\nTruncation can be disabled entirely, which means the server will never truncate but would instead return an error if the conversation exceeds the model\'s input token limit.\n'),
  "prompt": zod.union([zod.object({
  "id": zod.string().describe('The unique identifier of the prompt template to use.'),
  "version": zod.union([zod.string().describe('Optional version of the prompt template.'),zod.null()]).optional(),
  "variables": zod.union([zod.record(zod.string(), zod.union([zod.string(),zod.object({
  "type": zod.enum(['input_text']).default(createRealtimeClientSecretResponseSessionOnePromptOneVariablesOneTwoTypeDefault).describe('The type of the input item. Always `input_text`.'),
  "text": zod.string().describe('The text input to the model.'),
  "prompt_cache_breakpoint": zod.object({
  "mode": zod.enum(['explicit']).default(createRealtimeClientSecretResponseSessionOnePromptOneVariablesOneTwoPromptCacheBreakpointModeDefault).describe('The breakpoint mode. Always `explicit`.')
}).optional().describe('Marks the exact end of a reusable prompt prefix. The breakpoint inherits its TTL from the request\'s `prompt_cache_options.ttl`; the boundary is not rounded to a token block.')
}).describe('A text input to the model.'),zod.object({
  "type": zod.enum(['input_image']).default(createRealtimeClientSecretResponseSessionOnePromptOneVariablesOneThreeTypeDefault).describe('The type of the input item. Always `input_image`.'),
  "image_url": zod.union([zod.url().describe('The URL of the image to be sent to the model. A fully qualified URL or base64 encoded image in a data URL.'),zod.null()]).optional(),
  "file_id": zod.union([zod.string().describe('The ID of the file to be sent to the model.'),zod.null()]).optional(),
  "detail": zod.enum(['low', 'high', 'auto', 'original']).describe('The detail level of the image to be sent to the model. One of `high`, `low`, `auto`, or `original`. Defaults to `auto`.'),
  "prompt_cache_breakpoint": zod.object({
  ...
  "file_data": zod.string().optional().describe('The content of the file to be sent to the model.\n'),
  "prompt_cache_breakpoint": zod.object({
  "mode": zod.enum(['explicit']).default(createRealtimeClientSecretResponseSessionOnePromptOneVariablesOneFourPromptCacheBreakpointModeDefault).describe('The breakpoint mode. Always `explicit`.')
}).optional().describe('Marks the exact end of a reusable prompt prefix. The breakpoint inherits its TTL from the request\'s `prompt_cache_options.ttl`; the boundary is not rounded to a token block.'),
  "file_url": zod.url().optional().describe('The URL of the file to be sent to the model.'),
  "detail": zod.enum(['auto', 'low', 'high']).optional().describe('The detail level of the file to be sent to the model. Use `auto` to let the system select the detail level; for GPT-5.6 and later models, `auto` uses high-quality rendering, which may increase input token usage. Use `low` for lower-cost rendering, or `high` to render the file at higher quality. Defaults to `auto`.')
}).describe('A file input to the model.')])).describe('Optional map of values to substitute in for variables in your\nprompt. The substitution values can either be strings, or other\nResponse input types like images or files.\n'),zod.null()]).optional()
...
}).describe('Configuration for turn detection. Can be set to `null` to turn off. Server\nVAD means that the model will detect the start and end of speech based on\naudio volume and respond at the end of user speech. For `gpt-realtime-whisper`, this must be `null`; VAD is not supported.\n'),zod.null()]).optional().describe('Configuration for turn detection. For `gpt-realtime-whisper`, this must be `null`; VAD is not supported.\n')
}).optional()
...
export const createRealtimeSessionBodyTracingOneDefault = `auto`;
export const createRealtimeSessionBodyTruncationTwoRetentionRatioMin = 0;
export const createRealtimeSessionBodyTruncationTwoRetentionRatioMax = 1;

export const createRealtimeSessionBodyTruncationTwoTokenLimitsPostInstructionsMin = 0;

export const createRealtimeSessionBodyPromptOneVariablesOneTwoTypeDefault = `input_text`;
export const createRealtimeSessionBodyPromptOneVariablesOneTwoPromptCacheBreakpointModeDefault = `explicit`;
export const createRealtimeSessionBodyPromptOneVariablesOneThreeTypeDefault = `input_image`;
export const createRealtimeSessionBodyPromptOneVariablesOneThreePromptCacheBreakpointModeDefault = `explicit`;
export const createRealtimeSessionBodyPromptOneVariablesOneFourTypeDefault = `input_file`;
export const createRealtimeSessionBodyPromptOneVariablesOneFourPromptCacheBreakpointModeDefault = `explicit`;
...
export const CreateRealtimeSessionBody = zod.object({
  ...
  "tracing": zod.union([zod.enum(['auto']).default(createRealtimeSessionBodyTracingOneDefault).describe('Default tracing mode for the session.\n'),zod.object({
  "workflow_name": zod.string().optional().describe('The name of the workflow to attach to this trace. This is used to\nname the trace in the traces dashboard.\n'),
  "group_id": zod.string().optional().describe('The group id to attach to this trace to enable filtering and\ngrouping in the traces dashboard.\n'),
  "metadata": zod.looseObject({
  ...
  "max_response_output_tokens": zod.union([zod.number(),zod.enum(['inf'])]).optional().describe('Maximum number of output tokens for a single assistant response,\ninclusive of tool calls. Provide an integer between 1 and 4096 to\nlimit output tokens, or `inf` for the maximum available tokens for a\ngiven model. Defaults to `inf`.\n'),
  "truncation": zod.union([zod.enum(['auto', 'disabled']).describe('The truncation strategy to use for the session. `auto` is the default truncation strategy. `disabled` will disable truncation and emit errors when the conversation exceeds the input token limit.'),zod.object({
  "type": zod.enum(['retention_ratio']).describe('Use retention ratio truncation.'),
  "retention_ratio": zod.number().min(createRealtimeSessionBodyTruncationTwoRetentionRatioMin).max(createRealtimeSessionBodyTruncationTwoRetentionRatioMax).describe('Fraction of post-instruction conversation tokens to retain (`0.0` - `1.0`) when the conversation exceeds the input token limit. Setting this to `0.8` means that messages will be dropped until 80% of the maximum allowed tokens are used. This helps reduce the frequency of truncations and improve cache rates.\n'),
  "token_limits": zod.object({
  "post_instructions": zod.number().min(createRealtimeSessionBodyTruncationTwoTokenLimitsPostInstructionsMin).optional().describe('Maximum tokens allowed in the conversation after instructions (which including tool definitions). For example, setting this to 5,000 would mean that truncation would occur when the conversation exceeds 5,000 tokens after instructions. This cannot be higher than the model\'s context window size minus the maximum output tokens.')
}).optional().describe('Optional custom token limits for this truncation strategy. If not provided, the model\'s default token limits will be used.')
}).describe('Retain a fraction of the conversation tokens when the conversation exceeds the input token limit. This allows you to amortize truncations across multiple turns, which can help improve cached token usage.')]).optional().describe('When the number of tokens in a conversation exceeds the model\'s input token limit, the conversation be truncated, meaning messages (starting from the oldest) will not be included in the model\'s context. A 32k context model with 4,096 max output tokens can only include 28,224 tokens in the context before truncation occurs.\n\nClients can configure truncation behavior to truncate with a lower max token limit, which is an effective way to control token usage and cost.\n\nTruncation will reduce the number of cached tokens on the next turn (busting the cache), since messages are dropped from the beginning of the context. However, clients can also configure truncation to retain messages up to a fraction of the maximum context size, which will reduce the need for future truncations and thus improve the cache rate.\n\nTruncation can be disabled entirely, which means the server will never truncate but would instead return an error if the conversation exceeds the model\'s input token limit.\n'),
  "prompt": zod.union([zod.object({
  "id": zod.string().describe('The unique identifier of the prompt template to use.'),
  "version": zod.union([zod.string().describe('Optional version of the prompt template.'),zod.null()]).optional(),
  "variables": zod.union([zod.record(zod.string(), zod.union([zod.string(),zod.object({
  "type": zod.enum(['input_text']).default(createRealtimeSessionBodyPromptOneVariablesOneTwoTypeDefault).describe('The type of the input item. Always `input_text`.'),
  "text": zod.string().describe('The text input to the model.'),
  "prompt_cache_breakpoint": zod.object({
  "mode": zod.enum(['explicit']).default(createRealtimeSessionBodyPromptOneVariablesOneTwoPromptCacheBreakpointModeDefault).describe('The breakpoint mode. Always `explicit`.')
}).optional().describe('Marks the exact end of a reusable prompt prefix. The breakpoint inherits its TTL from the request\'s `prompt_cache_options.ttl`; the boundary is not rounded to a token block.')
}).describe('A text input to the model.'),zod.object({
  "type": zod.enum(['input_image']).default(createRealtimeSessionBodyPromptOneVariablesOneThreeTypeDefault).describe('The type of the input item. Always `input_image`.'),
  "image_url": zod.union([zod.url().describe('The URL of the image to be sent to the model. A fully qualified URL or base64 encoded image in a data URL.'),zod.null()]).optional(),
  "file_id": zod.union([zod.string().describe('The ID of the file to be sent to the model.'),zod.null()]).optional(),
  "detail": zod.enum(['low', 'high', 'auto', 'original']).describe('The detail level of the image to be sent to the model. One of `high`, `low`, `auto`, or `original`. Defaults to `auto`.'),
  "prompt_cache_breakpoint": zod.object({
  ...
  "file_data": zod.string().optional().describe('The content of the file to be sent to the model.\n'),
  "prompt_cache_breakpoint": zod.object({
  "mode": zod.enum(['explicit']).default(createRealtimeSessionBodyPromptOneVariablesOneFourPromptCacheBreakpointModeDefault).describe('The breakpoint mode. Always `explicit`.')
}).optional().describe('Marks the exact end of a reusable prompt prefix. The breakpoint inherits its TTL from the request\'s `prompt_cache_options.ttl`; the boundary is not rounded to a token block.'),
  "file_url": zod.url().optional().describe('The URL of the file to be sent to the model.'),
  "detail": zod.enum(['auto', 'low', 'high']).optional().describe('The detail level of the file to be sent to the model. Use `auto` to let the system select the detail level; for GPT-5.6 and later models, `auto` uses high-quality rendering, which may increase input token usage. Use `low` for lower-cost rendering, or `high` to render the file at higher quality. Defaults to `auto`.')
}).describe('A file input to the model.')])).describe('Optional map of values to substitute in for variables in your\nprompt. The substitution values can either be strings, or other\nResponse input types like images or files.\n'),zod.null()]).optional()
...
export const CreateRealtimeSessionResponse = zod.object({
  ...
  "voice": zod.union([zod.string(),zod.enum(['alloy', 'ash', 'ballad', 'coral', 'echo', 'sage', 'shimmer', 'verse', 'marin', 'cedar'])]).optional(),
  "speed": zod.number().optional()
}).optional()
}).optional().describe('Configuration for input and output audio for the session.\n'),
  "tracing": zod.union([zod.enum(['auto']).default(createRealtimeSessionResponseTracingOneDefault).describe('Default tracing mode for the session.\n'),zod.object({
  "workflow_name": zod.string().optional().describe('The name of the workflow to attach to this trace. This is used to\nname the trace in the traces dashboard.\n'),
  "group_id": zod.string().optional().describe('The group id to attach to this trace to enable filtering and\ngrouping in the traces dashboard.\n'),
  "metadata": zod.looseObject({
