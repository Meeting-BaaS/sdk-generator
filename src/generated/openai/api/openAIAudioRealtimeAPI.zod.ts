...
export const createSpeechBody = zod.object({
  model: zod
    .string()
    .or(zod.enum(["tts-1", "tts-1-hd", "gpt-4o-mini-tts", "gpt-4o-mini-tts-2025-12-15"]))
    .describe(
  ...
  voice: zod
    ...
    .or(
      zod
        ...
        .describe("Custom voice reference.")
    )
    .describe("A built-in voice name or a custom voice reference.\n"),
  response_format: zod
...
export const createTranscriptionResponse = zod
  .object({
  ...
  .describe("Represents a transcription response returned by model, based on the provided input.")
  .or(
    zod
      .object({
        task: zod
...
export const createVoiceResponse = zod
  .object({
    ...
    created_at: zod
      .number()
      .describe("The Unix timestamp (in seconds) for when the voice was created.")
  })
...
export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionInterruptResponseDefault = true
export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionIdleTimeoutMsMinOne = 5000
export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionIdleTimeoutMsMaxOne = 30000
export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionEagernessDefault = "auto"
export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionCreateResponseDefaultOne = true
export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionInterruptResponseDefaultOne = true
export const createRealtimeClientSecretBodySessionAudioOutputSpeedDefault = 1
...
export const createRealtimeClientSecretBodySessionTracingDefaultOne = "auto"
...
export const createRealtimeClientSecretBodySessionPromptVariablesTypeDefault = "input_text"
export const createRealtimeClientSecretBodySessionPromptVariablesTypeDefaultOne = "input_image"
export const createRealtimeClientSecretBodySessionPromptVariablesTypeDefaultTwo = "input_file"
export const createRealtimeClientSecretBodySessionAudioInputNoiseReductionDefaultOne = null
export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionTypeDefaultTwo =
  "server_vad"
export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionCreateResponseDefaultTwo = true
export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionInterruptResponseDefaultTwo = true
export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionIdleTimeoutMsMinFour = 5000
...
export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionEagernessDefaultOne =
  "auto"
export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionCreateResponseDefaultThree = true
export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionInterruptResponseDefaultThree = true

export const createRealtimeClientSecretBody = zod
  .object({
    expires_after: zod
      .object({
        anchor: zod
          .enum(["created_at"])
          .default(createRealtimeClientSecretBodyExpiresAfterAnchorDefault)
          .describe(
        ...
        seconds: zod
          .number()
          .min(createRealtimeClientSecretBodyExpiresAfterSecondsMin)
          .max(createRealtimeClientSecretBodyExpiresAfterSecondsMax)
          .default(createRealtimeClientSecretBodyExpiresAfterSecondsDefault)
          .describe(
    ...
    session: zod
      .object({
        ...
        output_modalities: zod
          ...
          .default(createRealtimeClientSecretBodySessionOutputModalitiesDefault)
          .describe(
        ...
        model: zod
          ...
          .optional()
          .describe("The Realtime model used for this session.\n"),
        instructions: zod
          .string()
          .optional()
          .describe(
        ...
        audio: zod
          .object({
                    ...
                    zod
                      .object({
                        ...
                        create_response: zod
                          .boolean()
                          .default(
                            createRealtimeClientSecretBodySessionAudioInputTurnDetectionCreateResponseDefault
                          )
                          .describe(
                        ...
                        interrupt_response: zod
                          .boolean()
                          .default(
                            createRealtimeClientSecretBodySessionAudioInputTurnDetectionInterruptResponseDefault
                          )
                          .describe(
                        ...
                        idle_timeout_ms: zod
                          .number()
                          .min(
                            createRealtimeClientSecretBodySessionAudioInputTurnDetectionIdleTimeoutMsMinOne
                          )
                          .max(
                            createRealtimeClientSecretBodySessionAudioInputTurnDetectionIdleTimeoutMsMaxOne
                          )
                          .describe(
                    ...
                    zod
                      .object({
                        ...
                        eagerness: zod
                          ...
                          .default(
                            createRealtimeClientSecretBodySessionAudioInputTurnDetectionEagernessDefault
                          )
                          .describe(
                        ...
                        create_response: zod
                          .boolean()
                          .default(
                            createRealtimeClientSecretBodySessionAudioInputTurnDetectionCreateResponseDefaultOne
                          )
                          .describe(
                        ...
                        interrupt_response: zod
                          .boolean()
                          .default(
                            createRealtimeClientSecretBodySessionAudioInputTurnDetectionInterruptResponseDefaultOne
                          )
                          .describe(
            ...
            output: zod
              .object({
                ...
                speed: zod
                  .number()
                  .min(createRealtimeClientSecretBodySessionAudioOutputSpeedMin)
                  .max(createRealtimeClientSecretBodySessionAudioOutputSpeedMax)
                  .default(createRealtimeClientSecretBodySessionAudioOutputSpeedDefault)
                  .describe(
          ...
          .optional()
          .describe("Configuration for input and output audio.\n"),
        include: zod
          .array(zod.enum(["item.input_audio_transcription.logprobs"]))
          .optional()
          .describe(
            ...
            zod
              .object({
                ...
                parameters: zod
                  .object({})
                  .optional()
                  .describe("Parameters of the function in JSON Schema.")
              })
              .or(
                zod
                  .object({
                    ...
                    allowed_tools: zod
                      .array(zod.string())
                      .describe("A string array of allowed tool names")
                      .or(
                        zod
                          .object({
                            tool_names: zod
                    ...
                    require_approval: zod
                      ...
                      .describe("Specify which of the MCP server's tools require approval.")
                      .or(zod.null())
                      .optional(),
                    defer_loading: zod
                      .boolean()
        ...
        tool_choice: zod
          ...
          .default(createRealtimeClientSecretBodySessionToolChoiceDefault)
          .describe(
          ...
          .or(
            zod
              .object({
                ...
                retention_ratio: zod
                  .number()
                  .min(createRealtimeClientSecretBodySessionTruncationRetentionRatioMin)
                  .max(createRealtimeClientSecretBodySessionTruncationRetentionRatioMax)
                  .describe(
                    "Fraction of post-instruction conversation tokens to retain (`0.0` - `1.0`) when the conversation exceeds the input token limit. Setting this to `0.8` means that messages will be dropped until 80% of the maximum allowed tokens are used. This helps reduce the frequency of truncations and improve cache rates.\n"
                  ),
                token_limits: zod
                  .object({
                    post_instructions: zod
                      .number()
                      .min(
                        createRealtimeClientSecretBodySessionTruncationTokenLimitsPostInstructionsMin
                      )
                      .optional()
                      .describe(
        ...
        prompt: zod
          .object({
            ...
            version: zod
              .string()
              .describe("Optional version of the prompt template.")
              .or(zod.null())
              .optional(),
            variables: zod
              .record(
                  ...
                  .or(
                    zod
                      .object({
                        ...
                        file_id: zod
                          .string()
                          .describe("The ID of the file to be sent to the model.")
                          .or(zod.null())
                          .optional(),
                        detail: zod.enum(["low", "high", "auto", "original"])
                      })
                      .describe(
                        ...
                        zod
                          .object({
                            ...
                            create_response: zod
                              .boolean()
                              .default(
                                createRealtimeClientSecretBodySessionAudioInputTurnDetectionCreateResponseDefaultTwo
                              )
                              .describe(
                                "Whether or not to automatically generate a response when a VAD stop event occurs. If `interrupt_response` is set to `false` this may fail to create a response if the model is already responding.\n\nIf both `create_response` and `interrupt_response` are set to `false`, the model will never respond automatically but VAD events will still be emitted.\n"
                              ),
                            interrupt_response: zod
                              .boolean()
                              .default(
                                createRealtimeClientSecretBodySessionAudioInputTurnDetectionInterruptResponseDefaultTwo
                              )
                              .describe(
                                "Whether or not to automatically interrupt (cancel) any ongoing response with output to the default\nconversation (i.e. `conversation` of `auto`) when a VAD start event occurs. If `true` then the response will be cancelled, otherwise it will continue until complete.\n\nIf both `create_response` and `interrupt_response` are set to `false`, the model will never respond automatically but VAD events will still be emitted.\n"
                              ),
                            idle_timeout_ms: zod
                              .number()
                              .min(
                                createRealtimeClientSecretBodySessionAudioInputTurnDetectionIdleTimeoutMsMinFour
                              )
                              .max(
                                createRealtimeClientSecretBodySessionAudioInputTurnDetectionIdleTimeoutMsMaxFour
                              )
                              .describe(
                                "Optional timeout after which a model response will be triggered automatically. This is\nuseful for situations in which a long pause from the user is unexpected, such as a phone\ncall. The model will effectively prompt the user to continue the conversation based\non the current context.\n\nThe timeout value will be applied after the last model response's audio has finished playing,\ni.e. it's set to the `response.done` time plus audio playback duration.\n\nAn `input_audio_buffer.timeout_triggered` event (plus events\nassociated with the Response) will be emitted when the timeout is reached.\nIdle timeout is currently only supported for `server_vad` mode.\n"
                              )
                        ...
                        zod
                          .object({
                            ...
                            eagerness: zod
                              .enum(["low", "medium", "high", "auto"])
                              .default(
                                createRealtimeClientSecretBodySessionAudioInputTurnDetectionEagernessDefaultOne
                              )
                              .describe(
                                "Used only for `semantic_vad` mode. The eagerness of the model to respond. `low` will wait longer for the user to continue speaking, `high` will respond more quickly. `auto` is the default and is equivalent to `medium`. `low`, `medium`, and `high` have max timeouts of 8s, 4s, and 2s respectively.\n"
                              ),
                            create_response: zod
                              .boolean()
                              .default(
                                createRealtimeClientSecretBodySessionAudioInputTurnDetectionCreateResponseDefaultThree
                              )
                              .describe(
                                "Whether or not to automatically generate a response when a VAD stop event occurs.\n"
                              ),
                            interrupt_response: zod
                              .boolean()
                              .default(
                                createRealtimeClientSecretBodySessionAudioInputTurnDetectionInterruptResponseDefaultThree
                              )
                              .describe(
                                "Whether or not to automatically interrupt any ongoing response with output to the default\nconversation (i.e. `conversation` of `auto`) when a VAD start event occurs.\n"
                              )
...
export const createRealtimeClientSecretResponseSessionAudioInputTurnDetectionTypeDefault =
  "server_vad"
export const createRealtimeClientSecretResponseSessionAudioInputTurnDetectionCreateResponseDefault = true
export const createRealtimeClientSecretResponseSessionAudioInputTurnDetectionInterruptResponseDefault = true
export const createRealtimeClientSecretResponseSessionAudioInputTurnDetectionIdleTimeoutMsMinOne = 5000
...
export const createRealtimeClientSecretResponseSessionAudioInputTurnDetectionEagernessDefault =
  "auto"
export const createRealtimeClientSecretResponseSessionAudioInputTurnDetectionCreateResponseDefaultOne = true
export const createRealtimeClientSecretResponseSessionAudioInputTurnDetectionInterruptResponseDefaultOne = true
...
export const createRealtimeClientSecretResponseSessionTracingDefaultTwo = "auto"
...
export const createRealtimeClientSecretResponseSessionPromptVariablesTypeDefault = "input_text"
export const createRealtimeClientSecretResponseSessionPromptVariablesTypeDefaultOne = "input_image"
export const createRealtimeClientSecretResponseSessionPromptVariablesTypeDefaultTwo = "input_file"

export const createRealtimeClientSecretResponse = zod
  .object({
      ...
      .discriminatedUnion("type", [
        zod
          .object({
              ...
              .object({
                        ...
                        zod
                          .object({
                            ...
                            create_response: zod
                              .boolean()
                              .default(
                                createRealtimeClientSecretResponseSessionAudioInputTurnDetectionCreateResponseDefault
                              )
                              .describe(
                                "Whether or not to automatically generate a response when a VAD stop event occurs. If `interrupt_response` is set to `false` this may fail to create a response if the model is already responding.\n\nIf both `create_response` and `interrupt_response` are set to `false`, the model will never respond automatically but VAD events will still be emitted.\n"
                              ),
                            interrupt_response: zod
                              .boolean()
                              .default(
                                createRealtimeClientSecretResponseSessionAudioInputTurnDetectionInterruptResponseDefault
                              )
                              .describe(
                                "Whether or not to automatically interrupt (cancel) any ongoing response with output to the default\nconversation (i.e. `conversation` of `auto`) when a VAD start event occurs. If `true` then the response will be cancelled, otherwise it will continue until complete.\n\nIf both `create_response` and `interrupt_response` are set to `false`, the model will never respond automatically but VAD events will still be emitted.\n"
                              ),
                            idle_timeout_ms: zod
                              .number()
                              .min(
                                createRealtimeClientSecretResponseSessionAudioInputTurnDetectionIdleTimeoutMsMinOne
                              )
                              .max(
                                createRealtimeClientSecretResponseSessionAudioInputTurnDetectionIdleTimeoutMsMaxOne
                              )
                              .describe(
                                "Optional timeout after which a model response will be triggered automatically. This is\nuseful for situations in which a long pause from the user is unexpected, such as a phone\ncall. The model will effectively prompt the user to continue the conversation based\non the current context.\n\nThe timeout value will be applied after the last model response's audio has finished playing,\ni.e. it's set to the `response.done` time plus audio playback duration.\n\nAn `input_audio_buffer.timeout_triggered` event (plus events\nassociated with the Response) will be emitted when the timeout is reached.\nIdle timeout is currently only supported for `server_vad` mode.\n"
                              )
                        ...
                        zod
                          .object({
                            ...
                            eagerness: zod
                              .enum(["low", "medium", "high", "auto"])
                              .default(
                                createRealtimeClientSecretResponseSessionAudioInputTurnDetectionEagernessDefault
                              )
                              .describe(
                                "Used only for `semantic_vad` mode. The eagerness of the model to respond. `low` will wait longer for the user to continue speaking, `high` will respond more quickly. `auto` is the default and is equivalent to `medium`. `low`, `medium`, and `high` have max timeouts of 8s, 4s, and 2s respectively.\n"
                              ),
                            create_response: zod
                              .boolean()
                              .default(
                                createRealtimeClientSecretResponseSessionAudioInputTurnDetectionCreateResponseDefaultOne
                              )
                              .describe(
                                "Whether or not to automatically generate a response when a VAD stop event occurs.\n"
                              ),
                            interrupt_response: zod
                              .boolean()
                              .default(
                                createRealtimeClientSecretResponseSessionAudioInputTurnDetectionInterruptResponseDefaultOne
                              )
                              .describe(
                                "Whether or not to automatically interrupt any ongoing response with output to the default\nconversation (i.e. `conversation` of `auto`) when a VAD start event occurs.\n"
                              )
                ...
                output: zod
                  .object({
                    ...
                    speed: zod
                      .number()
                      .min(createRealtimeClientSecretResponseSessionAudioOutputSpeedMin)
                      .max(createRealtimeClientSecretResponseSessionAudioOutputSpeedMax)
            ...
            tool_choice: zod
              ...
              .default(createRealtimeClientSecretResponseSessionToolChoiceDefault)
              .describe(
                "How the model chooses tools. Provide one of the string modes or force a specific\nfunction/MCP tool.\n"
              ),
            max_output_tokens: zod
              ...
              .or(
                zod
                  .object({
                    ...
                    retention_ratio: zod
                      .number()
                      .min(createRealtimeClientSecretResponseSessionTruncationRetentionRatioMin)
                    ...
                    token_limits: zod
                      .object({
                        post_instructions: zod
                          .number()
                          .min(
                            createRealtimeClientSecretResponseSessionTruncationTokenLimitsPostInstructionsMin
                          )
                          .optional()
                          .describe(
                            "Maximum tokens allowed in the conversation after instructions (which including tool definitions). For example, setting this to 5,000 would mean that truncation would occur when the conversation exceeds 5,000 tokens after instructions. This cannot be higher than the model's context window size minus the maximum output tokens."
        ...
        zod
          .object({
            ...
            object: zod
              .string()
              .describe("The object type. Always `realtime.transcription_session`."),
            expires_at: zod
              .number()
              .optional()
            ...
            audio: zod
                ...
                input: zod
                  .object({
                    ...
                    noise_reduction: zod
                      ...
                      .optional()
                      .describe("Configuration for input audio noise reduction.\n"),
                    turn_detection: zod
                      .object({
                        type: zod
                          .string()
              ...
              .optional()
              .describe("Configuration for input audio for the session.\n")
          })
...
export const createRealtimeSessionBodyTracingDefaultOne = "auto"
export const createRealtimeSessionBodyTruncationRetentionRatioMin = 0
...
export const createRealtimeSessionBodyPromptVariablesTypeDefault = "input_text"
export const createRealtimeSessionBodyPromptVariablesTypeDefaultOne = "input_image"
export const createRealtimeSessionBodyPromptVariablesTypeDefaultTwo = "input_file"

export const createRealtimeSessionBody = zod
  .object({
    client_secret: zod
      .object({
        value: zod
    ...
    voice: zod
      ...
      .optional()
      .describe("A built-in voice name or a custom voice reference.\n"),
    input_audio_format: zod
      .string()
      .optional()
      .describe("The format of input audio. Options are `pcm16`, `g711_ulaw`, or `g711_alaw`.\n"),
    output_audio_format: zod
      .string()
      .optional()
      .describe("The format of output audio. Options are `pcm16`, `g711_ulaw`, or `g711_alaw`.\n"),
    input_audio_transcription: zod
      .object({
    ...
    speed: zod
      .number()
      .min(createRealtimeSessionBodySpeedMin)
      .max(createRealtimeSessionBodySpeedMax)
      .default(createRealtimeSessionBodySpeedDefault)
      .describe(
        "The speed of the model's spoken response. 1.0 is the default speed. 0.25 is\nthe minimum speed. 1.5 is the maximum speed. This value can only be changed\nin between model turns, not while a response is in progress.\n"
      ),
    tracing: zod
      .enum(["auto"])
      .describe("Default tracing mode for the session.\n")
      .or(
        zod
          .object({
            workflow_name: zod
    ...
    turn_detection: zod
      .object({
        type: zod
          .string()
          .optional()
          .describe("Type of turn detection, only `server_vad` is currently supported.\n"),
        threshold: zod
          .number()
          .optional()
          .describe(
    ...
    tools: zod
      ...
      .optional()
      .describe("Tools (functions) available to the model."),
    tool_choice: zod
      .string()
      .optional()
      .describe(
    ...
    temperature: zod
      .number()
      .optional()
      .describe("Sampling temperature for the model, limited to [0.6, 1.2]. Defaults to 0.8.\n"),
    max_response_output_tokens: zod
      .number()
      .or(zod.enum(["inf"]))
      .optional()
      .describe(
      ...
      .or(
        zod
          .object({
            ...
            retention_ratio: zod
              .number()
              .min(createRealtimeSessionBodyTruncationRetentionRatioMin)
              .max(createRealtimeSessionBodyTruncationRetentionRatioMax)
              .describe(
                "Fraction of post-instruction conversation tokens to retain (`0.0` - `1.0`) when the conversation exceeds the input token limit. Setting this to `0.8` means that messages will be dropped until 80% of the maximum allowed tokens are used. This helps reduce the frequency of truncations and improve cache rates.\n"
              ),
            token_limits: zod
              .object({
                post_instructions: zod
                  .number()
                  .min(createRealtimeSessionBodyTruncationTokenLimitsPostInstructionsMin)
                  .optional()
                  .describe(
                    "Maximum tokens allowed in the conversation after instructions (which including tool definitions). For example, setting this to 5,000 would mean that truncation would occur when the conversation exceeds 5,000 tokens after instructions. This cannot be higher than the model's context window size minus the maximum output tokens."
                  )
...
export const createRealtimeSessionResponse = zod
  .object({
    id: zod
      .string()
      .optional()
      .describe("Unique identifier for the session that looks like `sess_1234567890abcdef`.\n"),
    ...
    audio: zod
        ...
        input: zod
          .object({
            ...
            turn_detection: zod
              ...
              .optional()
              .describe("Configuration for turn detection.\n")
          })
          .optional(),
        output: zod
          .object({
      ...
      .optional()
      .describe("Configuration for input and output audio for the session.\n"),
    tracing: zod
      .enum(["auto"])
      .describe("Default tracing mode for the session.\n")
      .or(
...
export const createRealtimeTranscriptionSessionBody = zod
  .object({
    turn_detection: zod
      .object({
        type: zod
    ...
    input_audio_noise_reduction: zod
      .object({
        type: zod
          .enum(["near_field", "far_field"])
          .optional()
    ...
    input_audio_format: zod
      ...
      .default(createRealtimeTranscriptionSessionBodyInputAudioFormatDefault)
      .describe(
...
export const createRealtimeTranscriptionSessionResponse = zod
  .object({
    client_secret: zod
      .object({
        value: zod
