...
export const createSpeechBody = zod.object({
  "model": zod.string().or(zod.enum(['tts-1', 'tts-1-hd', 'gpt-4o-mini-tts', 'gpt-4o-mini-tts-2025-12-15'])).describe('One of the available [TTS models](/docs/models#tts): `tts-1`, `tts-1-hd`, `gpt-4o-mini-tts`, or `gpt-4o-mini-tts-2025-12-15`.\n'),
  ...
  "voice": zod.string().or(zod.enum(['alloy', 'ash', 'ballad', 'coral', 'echo', 'sage', 'shimmer', 'verse', 'marin', 'cedar'])).or(zod.object({
  "id": zod.string().describe('The custom voice ID, e.g. `voice_1234`.')
}).describe('Custom voice reference.')).describe('A built-in voice name or a custom voice reference.\n'),
...
}).describe('Usage statistics for models billed by token usage.').or(zod.object({
...
export const createRealtimeClientSecretBodySessionTracingDefaultOne = "auto";export const createRealtimeClientSecretBodySessionTracingDefault = null;export const createRealtimeClientSecretBodySessionToolsItemRequireApprovalDefaultOne = "always";export const createRealtimeClientSecretBodySessionToolChoiceDefault = "auto";export const createRealtimeClientSecretBodySessionTruncationRetentionRatioMin = 0;
...
export const createRealtimeClientSecretBodySessionPromptVariablesTypeDefault = "input_text";export const createRealtimeClientSecretBodySessionPromptVariablesTypeDefaultOne = "input_image";export const createRealtimeClientSecretBodySessionPromptVariablesTypeDefaultTwo = "input_file";export const createRealtimeClientSecretBodySessionAudioInputNoiseReductionDefaultOne = null;export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionTypeDefaultTwo = "server_vad";export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionCreateResponseDefaultTwo = true;export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionInterruptResponseDefaultTwo = true;export const createRealtimeClientSecretBodySessionAudioInputTurnDetectionIdleTimeoutMsMinFour = 5000;
...
export const createRealtimeClientSecretBody = zod.object({
...
}).describe('The PCM audio format. Only a 24kHz sample rate is supported.').or(zod.object({
  "type": zod.enum(['audio/pcmu']).optional().describe('The audio format. Always `audio/pcmu`.')
}).describe('The G.711 μ-law format.')).or(zod.object({
  ...
  "voice": zod.string().or(zod.enum(['alloy', 'ash', 'ballad', 'coral', 'echo', 'sage', 'shimmer', 'verse', 'marin', 'cedar'])).or(zod.object({
  "id": zod.string().describe('The custom voice ID, e.g. `voice_1234`.')
}).describe('Custom voice reference.')).optional().describe('A built-in voice name or a custom voice reference.\n'),
...
}).describe('Granular configuration for tracing.\n')).nullish().describe('Realtime API can write session traces to the [Traces Dashboard](https://platform.openai.com/logs?api=traces). Set to null to disable tracing. Once\ntracing is enabled for a session, the configuration cannot be modified.\n\n`auto` will create a trace for the session with default values for the\nworkflow name, group id, and metadata.\n'),
...
}).describe('An image input to the model. Learn about [image inputs](/docs/guides/vision).')).or(zod.object({
...
}).describe('Realtime session object configuration.').or(zod.object({
...
export const createRealtimeClientSecretResponseSessionOutputModalitiesDefault: ('text' | 'audio')[] = ["audio"];export const createRealtimeClientSecretResponseSessionAudioInputNoiseReductionDefault = null;export const createRealtimeClientSecretResponseSessionAudioInputTurnDetectionTypeDefault = "server_vad";export const createRealtimeClientSecretResponseSessionAudioInputTurnDetectionCreateResponseDefault = true;export const createRealtimeClientSecretResponseSessionAudioInputTurnDetectionInterruptResponseDefault = true;export const createRealtimeClientSecretResponseSessionAudioInputTurnDetectionIdleTimeoutMsMinOne = 5000;
...
}).describe('Granular configuration for tracing.\n')).describe('Realtime API can write session traces to the [Traces Dashboard](https://platform.openai.com/logs?api=traces). Set to null to disable tracing. Once\ntracing is enabled for a session, the configuration cannot be modified.\n\n`auto` will create a trace for the session with default values for the\nworkflow name, group id, and metadata.\n').or(zod.null()).optional(),
  "tools": zod.array(zod.object({
 ...
 */
export const createRealtimeTranscriptionSessionBodyInputAudioNoiseReductionDefault = null;export const createRealtimeTranscriptionSessionBodyInputAudioFormatDefault = "pcm16";
