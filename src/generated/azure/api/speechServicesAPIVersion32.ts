...
export const modelsCopy = <TData = AxiosResponse<Operation>>(
  ...
  return axios.post(`/models/${id}:copy`, modelCopyAuthorization, options)
}
...
export const modelsAuthorizeCopy = <TData = AxiosResponse<ModelCopyAuthorization>>(
  ...
  return axios.post(`/models:authorizecopy`, modelCopyAuthorizationDefinition, options)
}
...
export const operationsGetModelCopy = <TData = AxiosResponse<Operation>>(
  ...
  return axios.get(`/operations/models/copy/${id}`, options)
}
  ...
  values: faker.helpers.arrayElement([
    Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
      ...
      properties: faker.helpers.arrayElement([
        {
          textNormalizationKind: faker.helpers.arrayElement([
            faker.helpers.arrayElement(Object.values(TextNormalizationKind)),
            undefined
          ]),
      ...
      properties: faker.helpers.arrayElement([
        {
          ...
          tokenErrorRate1: faker.helpers.arrayElement([faker.number.float(), undefined]),
          ...
          tokenCount1: faker.helpers.arrayElement([
            faker.number.int({ min: undefined, max: undefined }),
            undefined
          ]),
          correctTokenCount1: faker.helpers.arrayElement([
            faker.number.int({ min: undefined, max: undefined }),
            undefined
          ]),
          tokenSubstitutionCount1: faker.helpers.arrayElement([
            faker.number.int({ min: undefined, max: undefined }),
            undefined
          ]),
          tokenDeletionCount1: faker.helpers.arrayElement([
            faker.number.int({ min: undefined, max: undefined }),
            undefined
          ]),
          tokenInsertionCount1: faker.helpers.arrayElement([
            faker.number.int({ min: undefined, max: undefined }),
            undefined
          ]),
          tokenErrors1: faker.helpers.arrayElement([
            {
              punctuation: faker.helpers.arrayElement([
                {
                  numberOfEdits: faker.helpers.arrayElement([
                    faker.number.int({ min: undefined, max: undefined }),
                    undefined
                  ]),
                  percentageOfAllEdits: faker.helpers.arrayElement([
                    faker.number.float(),
                    undefined
                  ])
                },
              ...
              capitalization: faker.helpers.arrayElement([
                {
                  numberOfEdits: faker.helpers.arrayElement([
                    faker.number.int({ min: undefined, max: undefined }),
                    undefined
              ...
              inverseTextNormalization: faker.helpers.arrayElement([
                {
                  numberOfEdits: faker.helpers.arrayElement([
                    faker.number.int({ min: undefined, max: undefined }),
                    undefined
              ...
              lexical: faker.helpers.arrayElement([
                {
                  numberOfEdits: faker.helpers.arrayElement([
                    faker.number.int({ min: undefined, max: undefined }),
                    undefined
              ...
              others: faker.helpers.arrayElement([
                {
                  numberOfEdits: faker.helpers.arrayElement([
                    faker.number.int({ min: undefined, max: undefined }),
                    undefined
          ...
          tokenErrorRate2: faker.helpers.arrayElement([faker.number.float(), undefined]),
          ...
          tokenCount2: faker.helpers.arrayElement([
            faker.number.int({ min: undefined, max: undefined }),
            undefined
          ]),
          correctTokenCount2: faker.helpers.arrayElement([
            faker.number.int({ min: undefined, max: undefined }),
            undefined
          ]),
          tokenSubstitutionCount2: faker.helpers.arrayElement([
            faker.number.int({ min: undefined, max: undefined }),
            undefined
          ]),
          tokenDeletionCount2: faker.helpers.arrayElement([
            faker.number.int({ min: undefined, max: undefined }),
            undefined
          ]),
          tokenInsertionCount2: faker.helpers.arrayElement([
            faker.number.int({ min: undefined, max: undefined }),
            undefined
          ]),
          tokenErrors2: faker.helpers.arrayElement([
            {
              punctuation: faker.helpers.arrayElement([
                {
                  numberOfEdits: faker.helpers.arrayElement([
          ...
          punctuation: faker.helpers.arrayElement([
            {
              ...
              percentageOfAllEdits: faker.helpers.arrayElement([faker.number.float(), undefined])
            },
            undefined
          ]),
          capitalization: faker.helpers.arrayElement([
...
export const getModelsListCustomModelsResponseMock = (
  ...
  values: faker.helpers.arrayElement([
    Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
      ...
      links: faker.helpers.arrayElement([
        {
          copy: faker.helpers.arrayElement([faker.internet.url(), undefined]),
          files: faker.helpers.arrayElement([faker.internet.url(), undefined]),
          ...
          features: faker.helpers.arrayElement([
            {
              ...{
                ...
                supportedOutputFormats: faker.helpers.arrayElement([
                  faker.helpers.arrayElements(Object.values(OutputFormatType)),
                  undefined
                ])
              }
            },
      ...
      properties: faker.helpers.arrayElement([
        {
          ...
          chargeForAdaptation: faker.helpers.arrayElement([faker.datatype.boolean(), undefined])
        },
        undefined
      ])
    })),
...
export const getModelsCopyResponseMock = (
  overrideResponse: Partial<Operation> = {}
): Operation => ({
  id: faker.string.uuid(),
  result: faker.helpers.arrayElement([
    { link: faker.helpers.arrayElement([faker.internet.url(), undefined]) },
    undefined
  ]),
  error: faker.helpers.arrayElement([
    {
...
export const getModelsAuthorizeCopyResponseMock = (
  overrideResponse: Partial<ModelCopyAuthorization> = {}
): ModelCopyAuthorization => ({
  targetResourceRegion: faker.string.alpha(20),
  targetResourceId: faker.string.alpha(20),
  targetResourceEndpoint: faker.string.alpha(20),
  sourceResourceId: faker.string.alpha(20),
...
export const getOperationsGetModelCopyResponseMock = (
  overrideResponse: Partial<Operation> = {}
): Operation => ({
  id: faker.string.uuid(),
  result: faker.helpers.arrayElement([
          ...
          languageIdentification: faker.helpers.arrayElement([
            {
              mode: faker.helpers.arrayElement([
                faker.helpers.arrayElement(Object.values(LanguageIdentificationMode)),
                undefined
              ]),
...
export const getModelsCopyMockHandler = (
  overrideResponse?:
    | Operation
    | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<Operation> | Operation)
) => {
  return http.post("https://api.cognitive.microsoft.com/models/:id:copy", async (info) => {
    await delay(1000)
...
export const getModelsAuthorizeCopyMockHandler = (
  overrideResponse?:
    | ModelCopyAuthorization
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0]
      ) => Promise<ModelCopyAuthorization> | ModelCopyAuthorization)
) => {
  return http.post("https://api.cognitive.microsoft.com/models:authorizecopy", async (info) => {
    await delay(1000)
...
export const getOperationsGetModelCopyMockHandler = (
  overrideResponse?:
    | Operation
    | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<Operation> | Operation)
) => {
  return http.get(
    "https://api.cognitive.microsoft.com/operations/models/copy/:id",
    async (info) => {
      await delay(1000)
