...
export const datasetsListResponse = zod.object({
  ...
  "listBlocks": zod.string().url().optional().describe('The location to list the already uploaded blocks of this entity when uploading a dataset using blocks. See operation \"Datasets_GetBlocks\" for more details.'),
...
export const modelsCopyBody = zod.object({
  ...
  "expirationDateTime": zod.string().datetime({}).describe('The expiration date of this copy authorization.'),
...
export const modelsGetCustomModelManifestResponse = zod.object({
  ...
  "properties": zod.record(zod.string(), zod.any()).describe('The configuration for running this model in a container.')
})
...
export const operationsGetModelCopyParams = zod.object({
  "id": zod.string().uuid().describe('The identifier of the operation.')
})

export const operationsGetModelCopyResponse = zod.object({
  "id": zod.string().uuid().describe('The identifier of this Operation.'),
  "result": zod.object({
  "link": zod.string().url().optional().describe('The link to the result of the operation.')
}).optional(),
  "error": zod.object({
  "code": zod.string().optional().describe('The code of this error.'),
  "message": zod.string().optional().describe('The message for this error.')
