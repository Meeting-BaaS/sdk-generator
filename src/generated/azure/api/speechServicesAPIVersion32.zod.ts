  ...
  values: zod
    .array(
      zod.object({
        ...
        properties: zod
          .object({
            textNormalizationKind: zod
              .enum(["Default", "None"])
              .optional()
              .describe("The kind of text normalization."),
...
export const datasetsUploadBody = zod.object({
  ...
  kind: zod
    .string()
    .describe(
      'The kind of the dataset. Possible values are "Language", "Acoustic", "Pronunciation", "AudioFiles", "LanguageMarkdown", "OutputFormatting".'
    ),
  customProperties: zod
    .string()
    .optional()
        ...
        properties: zod
          .object({
            ...
            tokenErrorRate1: zod
              .number()
              .optional()
              .describe("The optional token error rate of recognition with model1."),
            sentenceCount1: zod
              .number()
              .optional()
            ...
            tokenCount1: zod
              .number()
              .optional()
              .describe("Optional the number of processed tokens by model1."),
            correctTokenCount1: zod
              .number()
              .optional()
              .describe("The optional number of correctly recognized tokens by model1."),
            tokenSubstitutionCount1: zod
              .number()
              .optional()
              .describe(
                "The optional number of recognized tokens by model1, that are substitutions."
              ),
            tokenDeletionCount1: zod
              .number()
              .optional()
              .describe("The optional number of recognized tokens by model1, that are deletions."),
            tokenInsertionCount1: zod
              .number()
              .optional()
              .describe("The optional number of recognized tokens by model1, that are insertions."),
            tokenErrors1: zod
              .object({
                punctuation: zod
                  .object({
            ...
            tokenErrorRate2: zod
              .number()
              .optional()
              .describe("The optional token error rate of recognition with model2."),
            sentenceCount2: zod
              .number()
              .optional()
            ...
            tokenCount2: zod
              .number()
              .optional()
              .describe("The optional number of processed tokens by model2."),
            correctTokenCount2: zod
              .number()
              .optional()
              .describe("The optional number of correctly recognized tokens by model2."),
            tokenSubstitutionCount2: zod
              .number()
              .optional()
              .describe(
                "The optional number of recognized tokens by model2, that are substitutions."
              ),
            tokenDeletionCount2: zod
              .number()
              .optional()
              .describe("The optional number of recognized tokens by model2, that are deletions."),
            tokenInsertionCount2: zod
              .number()
              .optional()
              .describe("The optional number of recognized tokens by model2, that are insertions."),
            tokenErrors2: zod
              .object({
                punctuation: zod
                  .object({
  ...
  properties: zod
    .object({
      ...
      tokenSubstitutionCount1: zod
        .number()
        .optional()
        .describe("The optional number of recognized tokens by model1, that are substitutions."),
      tokenDeletionCount1: zod
        .number()
        .optional()
        .describe("The optional number of recognized tokens by model1, that are deletions."),
      ...
      tokenSubstitutionCount2: zod
        .number()
        .optional()
        .describe("The optional number of recognized tokens by model2, that are substitutions."),
      tokenDeletionCount2: zod
        .number()
        .optional()
        .describe("The optional number of recognized tokens by model2, that are deletions."),
...
export const modelsCopyBody = zod.object({
  targetResourceRegion: zod
    .string()
    .min(1)
    .describe("The region (aka location) of the target speech resource (e.g., westus2)."),
  targetResourceId: zod
    .string()
    .min(1)
    .describe("The Azure Resource ID of the target speech resource."),
  targetResourceEndpoint: zod
    .string()
    .min(1)
    .describe(
      "The endpoint (base url) of the target resource (with custom domain name when it is used)."
    ),
  sourceResourceId: zod
    .string()
    .min(1)
    .describe("The Azure Resource ID of the source speech resource."),
  expirationDateTime: zod
    .string()
    .datetime({})
    .describe("The expiration date of this copy authorization."),
...
export const projectsListTranscriptionsResponseValuesItemPropertiesLanguageIdentificationModeDefault =
  "Continuous"
            ...
            languageIdentification: zod
              .object({
                mode: zod
                  ...
                  .default(
                    projectsListTranscriptionsResponseValuesItemPropertiesLanguageIdentificationModeDefault
                  )
                  .describe("The mode used for language identification."),
...
export const transcriptionsListResponseValuesItemPropertiesLanguageIdentificationModeDefault =
  "Continuous"
            ...
            languageIdentification: zod
              .object({
                mode: zod
                  .enum(["Continuous", "Single"])
                  .default(
                    transcriptionsListResponseValuesItemPropertiesLanguageIdentificationModeDefault
                  )
                  .describe("The mode used for language identification."),
                candidateLocales: zod
                  .array(zod.string())
    ...
    .object({
      ...
      languageIdentification: zod
        .object({
          mode: zod
            .enum(["Continuous", "Single"])
            .default(transcriptionsCreateBodyPropertiesLanguageIdentificationModeDefault)
            .describe("The mode used for language identification."),
          candidateLocales: zod
            .array(zod.string())
            .describe(
    ...
    .object({
      ...
      languageIdentification: zod
        .object({
          mode: zod
            .enum(["Continuous", "Single"])
            .default(transcriptionsGetResponsePropertiesLanguageIdentificationModeDefault)
            .describe("The mode used for language identification."),
          candidateLocales: zod
            .array(zod.string())
            .describe(
    ...
    .object({
      ...
      languageIdentification: zod
        .object({
          mode: zod
            .enum(["Continuous", "Single"])
            .default(transcriptionsUpdateResponsePropertiesLanguageIdentificationModeDefault)
            .describe("The mode used for language identification."),
          candidateLocales: zod
            .array(zod.string())
            .describe(
