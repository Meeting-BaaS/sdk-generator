    ...
    request_params: faker.helpers.arrayElement([
      {
        ...{
          ...
          pii_redaction: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]),
          pii_redaction_config: faker.helpers.arrayElement([
            {
              ...{
                entity_types: faker.helpers.arrayElement([
                  faker.helpers.arrayElement(Object.values(PiiRedactionEntityTypeEnum)),
                  undefined
                ]),
                processed_text_type: faker.helpers.arrayElement([
                  faker.helpers.arrayElement(["MARKER", "MASK"] as const),
                  undefined
                ])
              }
            },
