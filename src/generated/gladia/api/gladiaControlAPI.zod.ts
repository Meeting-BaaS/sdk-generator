...
export const preRecordedControllerInitPreRecordedJobV2Body = zod.object({
  ...
  audio_to_llm_config: zod
    .object({
      ...
      model: zod
        .string()
        .default(preRecordedControllerInitPreRecordedJobV2BodyAudioToLlmConfigModelDefault)
        .describe(
  ...
  pii_redaction_config: zod
    .object({
      entity_types: zod
        ...
        .describe("The entity types to redact")
        .optional()
        .describe("The entity types to redact"),
      processed_text_type: zod
        .enum(["MARKER", "MASK"])
        .optional()
        .describe("The type of processed text to return (marker or mask)")
    })
    .optional()
    .describe("PII redaction configuration, if `pii_redaction` is enabled"),
  custom_metadata: zod
            ...
            audio_to_llm_config: zod
              .object({
                ...
                model: zod
                  .string()
                  .default(
                    preRecordedControllerGetPreRecordedJobsV2ResponseItemsItemRequestParamsAudioToLlmConfigModelDefault
                  )
                  .describe(
                    "The model to use for the prompt execution. You can find the list of supported models [here](https://openrouter.ai/models)."
                  )
      ...
      audio_to_llm_config: zod
        .object({
          ...
          model: zod
            .string()
            .default(
              preRecordedControllerGetPreRecordedJobV2ResponseRequestParamsAudioToLlmConfigModelDefault
            )
            .describe(
              "The model to use for the prompt execution. You can find the list of supported models [here](https://openrouter.ai/models)."
            )
...
export const transcriptionControllerInitPreRecordedJobV2Body = zod.object({
  ...
  audio_to_llm_config: zod
    .object({
      ...
      model: zod
        .string()
        .default(transcriptionControllerInitPreRecordedJobV2BodyAudioToLlmConfigModelDefault)
        .describe(
          "The model to use for the prompt execution. You can find the list of supported models [here](https://openrouter.ai/models)."
        )
    })
          ...
          request_params: zod
            .object({
              ...
              audio_to_llm_config: zod
                .object({
                  ...
                  model: zod
                    .string()
                    .default(
                      transcriptionControllerListV2ResponseItemsItemRequestParamsAudioToLlmConfigModelDefault
                    )
                    .describe(
                      "The model to use for the prompt execution. You can find the list of supported models [here](https://openrouter.ai/models)."
                    )
              ...
              pii_redaction: zod
                .boolean()
                .optional()
                .describe("Enable PII redaction for this audio"),
              pii_redaction_config: zod
                .object({
                  entity_types: zod
                    .enum([
        ...
        audio_to_llm_config: zod
          .object({
            ...
            model: zod
              .string()
              .default(
                transcriptionControllerGetTranscriptV2ResponseRequestParamsAudioToLlmConfigModelDefault
              )
              .describe(
                "The model to use for the prompt execution. You can find the list of supported models [here](https://openrouter.ai/models)."
              )
              ...
              audio_to_llm_config: zod
                .object({
                  ...
                  model: zod
                    .string()
                    .default(
                      historyControllerGetListV1ResponseItemsItemRequestParamsAudioToLlmConfigModelDefault
                    )
                    .describe(
                      "The model to use for the prompt execution. You can find the list of supported models [here](https://openrouter.ai/models)."
                    )
