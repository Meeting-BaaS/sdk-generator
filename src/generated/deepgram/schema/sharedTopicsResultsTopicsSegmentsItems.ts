 ...
 */
import type { SharedTopicsResultsTopicsSegmentsItemsTopicsItems } from './sharedTopicsResultsTopicsSegmentsItemsTopicsItems.js';

export interface SharedTopicsResultsTopicsSegmentsItems {
  text?: string;
  start_word?: number;
  end_word?: number;
