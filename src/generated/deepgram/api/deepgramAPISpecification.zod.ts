 ...
 */
export const selfHostedV1DistributionCredentialsCreateQueryScopesDefault: ('self-hosted:products' | 'self-hosted:product:api' | 'self-hosted:product:engine' | 'self-hosted:product:license-proxy' | 'self-hosted:product:dgtools' | 'self-hosted:product:billing' | 'self-hosted:product:hotpepper' | 'self-hosted:product:metrics-server')[] = ["self-hosted:products"];export const selfHostedV1DistributionCredentialsCreateQueryProviderDefault: ('quay')[] = "quay";
