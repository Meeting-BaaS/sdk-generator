 ...
 */
export const selfHostedV1DistributionCredentialsCreateQueryScopesDefault: string[] = ["self-hosted:products"]
...
export const speakV1AudioGenerateQuerySampleRateDefault = 24000
...
export const speakV1AudioGenerateQueryParams = zod.object({
  ...
  sample_rate: zod
    ...
    .or(
      zod.literal(48000).nullable().describe("Encoding - opus. Sample rate is fixed at 48000 Hz.")
    )
    .default(speakV1AudioGenerateQuerySampleRateDefault)
    .describe(
