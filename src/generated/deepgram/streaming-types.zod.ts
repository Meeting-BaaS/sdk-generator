...
export const deepgramStreamingOnlyParams = zod.object({
  channels: zod
    .number()
    .optional()
    .describe("channels - see https://developers.deepgram.com/docs/channels"),
  encoding: zod
    .string()
    .optional()
    .describe("encoding - see https://developers.deepgram.com/docs/encoding"),
  sample_rate: zod
    .number()
    .optional()
    .describe("sample rate - see https://developers.deepgram.com/docs/sample-rate"),
  endpointing: zod
    .union([zod.literal(false), zod.number()])
    .optional()
    .describe("endpointing - see https://developers.deepgram.com/docs/endpointing"),
  interim_results: zod
    .boolean()
    .optional()
    .describe("interim results - see https://developers.deepgram.com/docs/interim-results"),
  no_delay: zod
    .boolean()
    .optional()
    .describe(
