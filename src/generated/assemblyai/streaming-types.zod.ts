...
export const streamingTranscriberParams = zod.object({
  ...
  speechModel: zod.enum(["universal-streaming-english", "universal-streaming-multilingual", "u3-rt-pro", "u3-rt-pro-beta-1", "whisper-rt", "universal-3-5-pro", "u3-pro"]).optional().describe("From SDK v3"),
