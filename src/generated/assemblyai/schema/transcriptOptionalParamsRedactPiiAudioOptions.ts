 ...
 */
import type { TranscriptOptionalParamsRedactPiiAudioOptionsOverrideAudioRedactionMethod } from './transcriptOptionalParamsRedactPiiAudioOptionsOverrideAudioRedactionMethod.js';

/**
 * Specify options for [PII redacted audio](https://www.assemblyai.com/docs/pii-redaction#request-for-redacted-audio) files.
 */
export type TranscriptOptionalParamsRedactPiiAudioOptions = {
