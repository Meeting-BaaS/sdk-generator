 ...
 */
export type TranscriptOptionalParamsLanguageDetectionOptionsOnNoSpeechDetected = typeof TranscriptOptionalParamsLanguageDetectionOptionsOnNoSpeechDetected[keyof typeof TranscriptOptionalParamsLanguageDetectionOptionsOnNoSpeechDetected];


export const TranscriptOptionalParamsLanguageDetectionOptionsOnNoSpeechDetected = {
  error: 'error',
  fallback: 'fallback',
} as const;
