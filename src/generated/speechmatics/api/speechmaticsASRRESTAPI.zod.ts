...
export const postJobsBody = zod.object({
  "config": zod.string().describe('JSON containing a [`JobConfig`](/speech-to-text/batch/input#jobconfig-schema) model indicating the type and parameters for the recognition job.'),
...
export const getJobsResponseJobsItemConfigSummarizationConfigContentTypeDefault = "auto";export const getJobsResponseJobsItemConfigSummarizationConfigSummaryLengthDefault = "brief";
...
export const getJobsJobidResponseJobConfigSummarizationConfigContentTypeDefault = "auto";export const getJobsJobidResponseJobConfigSummarizationConfigSummaryLengthDefault = "brief";
...
export const getJobsJobidResponse = zod.object({
  ...
  "summarization_config": zod.object({
  "content_type": zod.enum(['auto', 'informative', 'conversational']).default(getJobsJobidResponseJobConfigSummarizationConfigContentTypeDefault).describe('Choose from three options:\n- `conversational` - Best suited for dialogues involving multiple participants, such as calls, meetings or discussions. It focuses on summarizing key points of the conversation.\n- `informative` - Recommended for more structured information delivered by one or more people, making it ideal for videos, podcasts, lectures, and presentations.\n- `auto` - Automatically selects the most appropriate content type based on an analysis of the transcript.\n'),
...
export const deleteJobsJobidResponseJobConfigSummarizationConfigContentTypeDefault = "auto";export const deleteJobsJobidResponseJobConfigSummarizationConfigSummaryLengthDefault = "brief";
...
export const deleteJobsJobidResponse = zod.object({
  ...
  "summarization_config": zod.object({
  "content_type": zod.enum(['auto', 'informative', 'conversational']).default(deleteJobsJobidResponseJobConfigSummarizationConfigContentTypeDefault).describe('Choose from three options:\n- `conversational` - Best suited for dialogues involving multiple participants, such as calls, meetings or discussions. It focuses on summarizing key points of the conversation.\n- `informative` - Recommended for more structured information delivered by one or more people, making it ideal for videos, podcasts, lectures, and presentations.\n- `auto` - Automatically selects the most appropriate content type based on an analysis of the transcript.\n'),
...
export const getJobsJobidTranscriptResponse = zod.object({
  ...
  "orchestrator_version": zod.string().optional().describe('The engine version used to generate transcription output.'),
