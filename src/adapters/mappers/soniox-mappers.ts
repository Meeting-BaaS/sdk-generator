export * from "../soniox/mappers"
/**
 * Soniox API mappers: unified types ↔ Soniox API types
 */

import type { UnifiedTranscriptResponse, Word, Utterance } from "../../router/types"
...
// Token shape from Soniox batch/stream response
...
/** Build utterances from tokens for streaming (e.g. Soniox WebSocket) */
