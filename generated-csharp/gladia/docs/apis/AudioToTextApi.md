# Gladia.SDK.Api.AudioToTextApi

All URIs are relative to *https://api.gladia.io*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**AudioToTextControllerAudioTranscription**](AudioToTextApi.md#audiototextcontrolleraudiotranscription) | **POST** /audio/text/audio-transcription |  |
