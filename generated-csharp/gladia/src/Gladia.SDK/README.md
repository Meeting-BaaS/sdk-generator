...
inputSpec: specs/gladia-openapi-csharp.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{2BCAE396-1A1F-4189-B283-24F5AB0C18A4}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAudioToTextApi>();
            IAudioToTextControllerAudioTranscriptionApiResponse apiResponse = await api.AudioToTextControllerAudioTranscriptionAsync("todo");
