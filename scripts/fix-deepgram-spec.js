...
const DEEPGRAM_SPEC_URL = "https://raw.githubusercontent.com/deepgram/deepgram-api-specs/main/openapi.yml"
const OUTPUT_PATH = path.join(__dirname, "../specs/deepgram-openapi.yml")

console.log("🔧 Fixing Deepgram OpenAPI spec...")

// Download spec
https.get(DEEPGRAM_SPEC_URL, (res) => {
  let data = ""
  ...
  res.on("end", () => {
    ...
    console.log(`📊 Removed duplicates: SpeakV1ContainerParameter, SpeakV1EncodingParameter, SpeakV1SampleRateParameter`)
  })
}).on("error", (err) => {
